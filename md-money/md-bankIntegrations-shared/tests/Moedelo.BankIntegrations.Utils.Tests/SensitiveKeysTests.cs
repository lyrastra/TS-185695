...
using Moedelo.BankIntegrations.Utils.Services;
using Moq;
using NUnit.Framework;
using System;
using System.Net.Http;

namespace Moedelo.BankIntegrations.Utils.Tests
{
    ...
    public class SensitiveDataMaskerTests
    {
        ...
        private Mock<ILogger<SensitiveDataMaskService>> loggerMock;

        //Authorization: Basic bW9lZGVsbzpqckxWYUhBektFS1I4TWhyVHlLR0dvTXJkRTU2bGc
        [SetUp]
        public void Setup()
        {
            ...
            loggerMock = new Mock<ILogger<SensitiveDataMaskService>>();
        ...
        [Test]
        public void MaskSensitiveData_HTTPHeaders_Authorization_ShouldEncryptAuthorizationAndApiKey()
        {
            // Arrange
            string httpHeaders = @"Authorization: 01D618aB62a96d5DedbA1DE82C9bB79bE1DD92";

            string expectedOutput = "Authorization: EncryptedBearerToken";

            // Настройка моков для шифрования
            cryptoServiceMock.Setup(cs => cs.EncryptText("01D618aB62a96d5DedbA1DE82C9bB79bE1DD92")).Returns("EncryptedBearerToken");
        ...
        public void MaskSensitiveData_EmptyString_ShouldReturnEmptyString()
        {
            ...
            // Assert
            emptyInput.Should().Be(actualOutput);
        }
