...
namespace Moedelo.BankIntegrations.Dto.IntegratedFile
{
    /// <summary> Секция документ в формате 1С </summary>
    /// sourse md-commonV2/src/clients/bankIntegrations/Moedelo.BankIntegrationsV2.Dto/IntegratedFile/DocumentSection.cs
    public class DocumentSectionDto
    {
        public DocumentSectionDto()
        {
