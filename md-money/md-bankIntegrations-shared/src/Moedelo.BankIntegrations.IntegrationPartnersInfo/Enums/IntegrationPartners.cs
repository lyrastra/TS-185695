...
namespace Moedelo.BankIntegrations.IntegrationPartnersInfo.Enums
{
    public enum IntegrationPartners
    {
        ...
        [IntegrationPartnerInfo("Прио-Внешторгбанк", "Прио-Внешторгбанка", "прио-внешторгбанк", "Прио-Внешторгбанке", "", IsCanBeIntegrated = true, IsIntegrationMonitor = true, IsBank = true, InDevelopment = true, BankLicenseNumbers = [212])]
        Vneshtorg = 1078,
    }
}
