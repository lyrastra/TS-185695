...
public class WorkerForInsuredFssAddressPartData
{
    public WorkerForInsuredFssAddressPartData(string name, string type, string fullName, AddressPartLevel level, Guid? guid)
    {
        Name = name;
        Type = type;
        FullName = fullName;
