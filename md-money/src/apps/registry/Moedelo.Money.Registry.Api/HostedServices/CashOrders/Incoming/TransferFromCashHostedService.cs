    ...
    public class TransferFromCashHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<TransferFromCashCreated>(OnCreatedAsync)
                .OnEvent<TransferFromCashUpdated>(OnUpdatedAsync)
                .OnEvent<TransferFromCashDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(TransferFromCashCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.CreateAsync(
                eventData.MapToCommand());
        }

        private Task OnUpdatedAsync(TransferFromCashUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(TransferFromCashDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
