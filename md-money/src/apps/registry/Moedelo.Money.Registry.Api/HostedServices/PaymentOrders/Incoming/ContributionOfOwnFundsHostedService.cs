...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class ContributionOfOwnFundsHostedService : BackgroundService
    {
        ...
        private Task OnCreate(ContributionOfOwnFundsCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(ContributionOfOwnFundsUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
