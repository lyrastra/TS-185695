    ...
    public class CurrencyPaymentFromCustomerHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<CurrencyPaymentFromCustomerCreated>(OnCreatedAsync)
                .OnEvent<CurrencyPaymentFromCustomerUpdated>(OnUpdatedAsync)
                .OnEvent<CurrencyPaymentFromCustomerDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(CurrencyPaymentFromCustomerCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(CurrencyPaymentFromCustomerUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(CurrencyPaymentFromCustomerDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
