...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class TransferFromCashHostedService : BackgroundService
    {
        ...
        private Task OnCreate(TransferFromCashCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(TransferFromCashUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
