...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class OtherIncomingHostedService : BackgroundService
    {
        ...
        private Task OnCreate(OtherIncomingCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(OtherIncomingUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
