...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class TransferFromPurseHostedService : BackgroundService
    {
        ...
        private Task OnCreate(TransferFromPurseCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(TransferFromPurseUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
