...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class IncomingCurrencySaleHostedService : BackgroundService
    {
        ...
        private Task OnCreate(IncomingCurrencySaleCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(IncomingCurrencySaleUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
