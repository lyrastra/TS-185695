...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class TransferFromCashCollectionHostedService : BackgroundService
    {
        ...
        private Task OnCreate(TransferFromCashCollectionCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.CreateAsync(
                eventData.MapToCommand());
        }

        private Task OnUpdate(TransferFromCashCollectionUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
