...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Incoming
{
    public class ContributionToAuthorizedCapitalHostedService : BackgroundService
    {
        ...
        private Task OnCreate(ContributionToAuthorizedCapitalCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(ContributionToAuthorizedCapitalUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
