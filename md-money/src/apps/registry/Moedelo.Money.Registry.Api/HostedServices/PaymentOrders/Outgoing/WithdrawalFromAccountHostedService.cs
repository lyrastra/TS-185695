    ...
    public class WithdrawalFromAccountHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<WithdrawalFromAccountCreated>(OnCreatedAsync)
                .OnEvent<WithdrawalFromAccountUpdated>(OnUpdatedAsync)
                .OnEvent<WithdrawalFromAccountDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(WithdrawalFromAccountCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(WithdrawalFromAccountUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(WithdrawalFromAccountDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
