    ...
    public class DeductionHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<DeductionCreated>(OnCreatedAsync)
                .OnEvent<DeductionUpdated>(OnUpdatedAsync)
                .OnEvent<DeductionDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(DeductionCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(DeductionUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(DeductionDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
