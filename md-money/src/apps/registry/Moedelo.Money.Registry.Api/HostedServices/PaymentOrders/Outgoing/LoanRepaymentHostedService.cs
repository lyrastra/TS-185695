    ...
    public class LoanRepaymentHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<LoanRepaymentCreated>(OnCreatedAsync)
                .OnEvent<LoanRepaymentUpdated>(OnUpdatedAsync)
                .OnEvent<LoanRepaymentDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(LoanRepaymentCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(LoanRepaymentUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(LoanRepaymentDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
