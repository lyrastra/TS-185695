    ...
    public class AgencyContractHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<AgencyContractCreated>(OnCreatedAsync)
                .OnEvent<AgencyContractUpdated>(OnUpdatedAsync)
                .OnEvent<AgencyContractDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(AgencyContractCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(AgencyContractUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(AgencyContractDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
