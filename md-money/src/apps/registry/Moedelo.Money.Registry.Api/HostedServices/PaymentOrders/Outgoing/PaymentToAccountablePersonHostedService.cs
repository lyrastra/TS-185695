    ...
    public class PaymentToAccountablePersonHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<PaymentToAccountablePersonCreated>(OnCreatedAsync)
                .OnEvent<PaymentToAccountablePersonUpdated>(OnUpdatedAsync)
                .OnEvent<PaymentToAccountablePersonDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(PaymentToAccountablePersonCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(PaymentToAccountablePersonUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(PaymentToAccountablePersonDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
