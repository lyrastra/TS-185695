    ...
    public class UnifiedBudgetaryPaymentHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<UnifiedBudgetaryPaymentCreated>(OnCreatedAsync)
                .OnEvent<UnifiedBudgetaryPaymentUpdated>(OnUpdatedAsync)
                .OnEvent<UnifiedBudgetaryPaymentDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(UnifiedBudgetaryPaymentCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(UnifiedBudgetaryPaymentUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(UnifiedBudgetaryPaymentDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
