    ...
    public class OutgoingCurrencyPurchaseHostedService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            return eventReaderBuilder
                .OnEvent<OutgoingCurrencyPurchaseCreated>(OnCreatedAsync)
                .OnEvent<OutgoingCurrencyPurchaseUpdated>(OnUpdatedAsync)
                .OnEvent<OutgoingCurrencyPurchaseDeleted>(OnDeletedAsync)
                .SkipIfUnknownType()
        ...
        private Task OnCreatedAsync(OutgoingCurrencyPurchaseCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdatedAsync(OutgoingCurrencyPurchaseUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            return registryOperationUpdater.UpdateAsync(
                eventData.MapToCommand());
        }

        private Task OnDeletedAsync(OutgoingCurrencyPurchaseDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
