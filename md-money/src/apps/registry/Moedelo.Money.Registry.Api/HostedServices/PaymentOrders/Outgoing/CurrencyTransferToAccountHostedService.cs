...
namespace Moedelo.Money.Registry.Api.HostedServices.PaymentOrders.Outgoing
{
    public class CurrencyTransferToAccountHostedService : BackgroundService
    {
        ...
        private Task OnCreate(CurrencyTransferToAccountCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private Task OnUpdate(CurrencyTransferToAccountUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
