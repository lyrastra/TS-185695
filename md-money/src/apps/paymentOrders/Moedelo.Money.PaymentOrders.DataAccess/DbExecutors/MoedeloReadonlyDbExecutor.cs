...
internal class MoedeloReadonlyDbExecutor(
    ISqlDbExecutor sqlDbExecutor,
    ISettingRepository settingRepository,
    IAuditTracer auditTracer)
    : MoedeloSqlDbExecutorBase(sqlDbExecutor, settingRepository.GetReadOnlyConnectionString(), auditTracer),
        IMoedeloReadonlyDbExecutor;