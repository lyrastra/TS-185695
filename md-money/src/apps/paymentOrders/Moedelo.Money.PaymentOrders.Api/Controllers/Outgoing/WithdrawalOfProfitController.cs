...
namespace Moedelo.Money.PaymentOrders.Api.Controllers.Outgoing
{
    ...
    public class WithdrawalOfProfitController : ControllerBase
    {
        ...
        public WithdrawalOfProfitController(
        ...
        {
            var model = await reader.GetByBaseIdAsync(documentBaseId, OperationType.PaymentOrderOutgoingWithdrawalOfProfit).ConfigureAwait(false);
            var data = WithdrawalOfProfitMapper.Map(model);
        ...
        [ProducesResponseType(404)]
        public async Task<IActionResult> CreateAsync(WithdrawalOfProfitDto dto)
        {
            var request = WithdrawalOfProfitMapper.Map(dto);
        ...
        [ProducesResponseType(200)]
        [ProducesResponseType(404)]
        public async Task<IActionResult> UpdateAsync(long documentBaseId, [FromBody] WithdrawalOfProfitDto dto)
        {
