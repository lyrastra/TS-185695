...
namespace Moedelo.Money.PaymentOrders.Api.Mappers.PaymentOrders.Incoming
{
    ...
    {
        public static ContributionToAuthorizedCapitalDto Map(PaymentOrderResponse model)
        {
        ...
        public static PaymentOrderSaveRequest Map(ContributionToAuthorizedCapitalDto dto)
        {
