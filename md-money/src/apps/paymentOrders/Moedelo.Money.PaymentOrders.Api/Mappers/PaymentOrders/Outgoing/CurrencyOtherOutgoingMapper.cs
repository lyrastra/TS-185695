...
{
    internal class CurrencyOtherOutgoingMapper
    {
        public static PaymentOrderSaveRequest Map(CurrencyOtherOutgoingDto dto)
        {
        ...
        public static CurrencyOtherOutgoingDto Map(PaymentOrderResponse model)
        {
            var result = new CurrencyOtherOutgoingDto
            {
