...
namespace Moedelo.Money.ChangeLog.HostedServices.CashOrders.Incoming
{
    ...
    {
        private static ContributionOfOwnFundsStateDefinition StateDefinition => ContributionOfOwnFundsStateDefinition.Instance;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            await eventReaderBuilder
                .OnEvent<ContributionOfOwnFundsCreated>(OnCreated)
                .OnEvent<ContributionOfOwnFundsUpdated>(OnUpdated)
                .OnEvent<ContributionOfOwnFundsDeleted>(OnDeleted)
                .SkipIfUnknownType()
        ...
        private async Task OnCreated(ContributionOfOwnFundsCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdated(ContributionOfOwnFundsUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(eventData.CashId);
            await changeLogCommandWriter.WriteAsync(
        ...
        private Task OnDeleted(ContributionOfOwnFundsDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
