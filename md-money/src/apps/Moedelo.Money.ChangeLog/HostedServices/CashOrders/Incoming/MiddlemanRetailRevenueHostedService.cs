...
namespace Moedelo.Money.ChangeLog.HostedServices.CashOrders.Incoming
{
    ...
    {
        private static MiddlemanRetailRevenueStateDefinition StateDefinition =>
            MiddlemanRetailRevenueStateDefinition.Instance;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            await eventReaderBuilder
                .OnEvent<MiddlemanRetailRevenueCreated>(OnCreated)
                .OnEvent<MiddlemanRetailRevenueUpdated>(OnUpdated)
                .OnEvent<MiddlemanRetailRevenueDeleted>(OnDeleted)
                .SkipIfUnknownType()
        ...
        private async Task OnCreated(MiddlemanRetailRevenueCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdated(MiddlemanRetailRevenueUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.CashId,
                eventData.ContractBaseId);
        ...
        private Task OnDeleted(MiddlemanRetailRevenueDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
