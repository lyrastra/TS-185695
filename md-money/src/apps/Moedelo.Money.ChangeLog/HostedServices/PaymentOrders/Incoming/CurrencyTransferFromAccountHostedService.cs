...
{
    public class CurrencyTransferFromAccountHostedService : BackgroundService
    {
        private static CurrencyTransferFromAccountStateDefinition StateDefinition =>
            CurrencyTransferFromAccountStateDefinition.Instance;

        private readonly ILogger logger;
        private readonly ICurrencyTransferFromAccountEventReader eventReader;
        ...
        public CurrencyTransferFromAccountHostedService(
            ILogger<CurrencyTransferFromAccountHostedService> logger,
            ISettingRepository settingRepository,
            ICurrencyTransferFromAccountEventReader eventReader,
        ...
        private async Task OnCreate(CurrencyTransferFromAccountCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(CurrencyTransferFromAccountUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId,
        ...
        private Task OnDelete(CurrencyTransferFromAccountDeletedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            ...
            int fromSettlementAccountId)
        {
            ...
            return new ExtraStateInfo
            {
                ...
                FromSettlementAccount = settlementAccounts.FirstOrDefault(x => x.Id == fromSettlementAccountId)
            };
        }
