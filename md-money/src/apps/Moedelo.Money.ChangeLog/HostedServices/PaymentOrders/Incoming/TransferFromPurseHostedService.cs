...
{
    public class TransferFromPurseHostedService : BackgroundService
    {
        private static TransferFromPurseStateDefinition StateDefinition =>
            TransferFromPurseStateDefinition.Instance;

        private readonly ILogger logger;
        private readonly ITransferFromPurseEventReader eventReader;
        ...
        public TransferFromPurseHostedService(
            ILogger<TransferFromPurseHostedService> logger,
            ISettingRepository settingRepository,
            ITransferFromPurseEventReader eventReader,
        ...
        private async Task OnCreate(TransferFromPurseCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(TransferFromPurseUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId);
        ...
        private Task OnDelete(TransferFromPurseDeletedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
