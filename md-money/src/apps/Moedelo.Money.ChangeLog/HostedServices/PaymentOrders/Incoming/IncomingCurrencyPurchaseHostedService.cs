...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Incoming
{
    ...
    {
        private static IncomingCurrencyPurchaseStateDefinition StateDefinition =>
            IncomingCurrencyPurchaseStateDefinition.Instance;
        ...
        private async Task OnCreate(IncomingCurrencyPurchaseCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(IncomingCurrencyPurchaseUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId,
                eventData.FromSettlementAccountId);
