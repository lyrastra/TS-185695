...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Incoming
{
    ...
    {
        private static AccrualOfInterestStateDefinition StateDefinition =>
            AccrualOfInterestStateDefinition.Instance;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            await eventReaderBuilder
                .OnEvent<AccrualOfInterestCreated>(OnCreated)
                .OnEvent<AccrualOfInterestUpdated>(OnUpdated)
                .OnEvent<AccrualOfInterestDeleted>(OnDeleted)
                .SkipIfUnknownType()
        ...
        private async Task OnCreated(AccrualOfInterestCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdated(AccrualOfInterestUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(eventData.SettlementAccountId);
        ...
        private Task OnDeleted(AccrualOfInterestDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
