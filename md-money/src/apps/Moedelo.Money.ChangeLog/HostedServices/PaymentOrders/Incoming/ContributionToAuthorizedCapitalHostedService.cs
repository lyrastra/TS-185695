...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Incoming
{
    ...
    {
        private static ContributionToAuthorizedCapitalStateDefinition StateDefinition =>
            ContributionToAuthorizedCapitalStateDefinition.Instance;

        private readonly ILogger logger;
        private readonly IContributionToAuthorizedCapitalEventReader eventReader;
        ...
        public ContributionToAuthorizedCapitalHostedService(
            ...
            IContributionToAuthorizedCapitalEventReader eventReader,
        ...
        private async Task OnCreate(ContributionToAuthorizedCapitalCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(ContributionToAuthorizedCapitalUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(eventData.SettlementAccountId);
        ...
        private Task OnDelete(ContributionToAuthorizedCapitalDeletedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
