...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Incoming
{
    ...
    {
        private static TransferFromAccountStateDefinition StateDefinition =>
            TransferFromAccountStateDefinition.Instance;
        ...
        private async Task OnCreate(TransferFromAccountCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(TransferFromAccountUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId,
                eventData.FromSettlementAccountId);
            ...
            int fromSettlementAccountId)
        {
            ...
            var fromSettlementAccount = await settlementAccountApiClient.GetByIdAsync(
                executionContext.FirmId,
                executionContext.UserId,
            ...
            return new ExtraStateInfo
            {
                ...
                FromSettlementAccount = fromSettlementAccount
            };
        }
