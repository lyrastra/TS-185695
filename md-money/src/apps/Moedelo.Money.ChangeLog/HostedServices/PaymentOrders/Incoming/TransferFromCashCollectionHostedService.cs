...
{
    public class TransferFromCashCollectionHostedService : BackgroundService
    {
        private static TransferFromCashCollectionStateDefinition StateDefinition =>
            TransferFromCashCollectionStateDefinition.Instance;

        private readonly ILogger logger;
        private readonly ITransferFromCashCollectionEventReader eventReader;
        ...
        public TransferFromCashCollectionHostedService(
            ILogger<TransferFromCashCollectionHostedService> logger,
            ISettingRepository settingRepository,
            ITransferFromCashCollectionEventReader eventReader,
        ...
        private async Task OnCreate(TransferFromCashCollectionCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(TransferFromCashCollectionUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(eventData.SettlementAccountId);
        ...
        private Task OnDelete(TransferFromCashCollectionDeletedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
