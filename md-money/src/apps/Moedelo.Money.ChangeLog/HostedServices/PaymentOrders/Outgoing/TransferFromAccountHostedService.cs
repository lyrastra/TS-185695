...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Outgoing
{
    ...
    {
        private static TransferToAccountStateDefinition StateDefinition =>
            TransferToAccountStateDefinition.Instance;
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            await eventReaderBuilder
                .OnEvent<TransferToAccountCreated>(OnCreated)
                .OnEvent<TransferToAccountUpdated>(OnUpdated)
                .OnEvent<TransferToAccountDeleted>(OnDeleted)
                .SkipIfUnknownType()
        ...
        private async Task OnCreated(TransferToAccountCreated eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdated(TransferToAccountUpdated eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId,
                eventData.ToSettlementAccountId);
        ...
        private Task OnDeleted(TransferToAccountDeleted eventData, KafkaMessageValueMetadata eventMetadata)
        {
            ...
            int toSettlementAccountId)
        {
            ...
            var toSettlementAccount = await settlementAccountApiClient.GetByIdAsync(
                executionContext.FirmId,
                executionContext.UserId,
            ...
            return new ExtraStateInfo
            {
                ...
                ToSettlementAccount = toSettlementAccount
            };
        }
