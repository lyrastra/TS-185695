...
namespace Moedelo.Money.ChangeLog.HostedServices.PaymentOrders.Outgoing
{
    ...
    {
        private static CurrencyOtherOutgoingStateDefinition StateDefinition =>
            CurrencyOtherOutgoingStateDefinition.Instance;
        ...
        private async Task OnCreate(CurrencyOtherOutgoingCreatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
        ...
        private async Task OnUpdate(CurrencyOtherOutgoingUpdatedMessage eventData, KafkaMessageValueMetadata eventMetadata)
        {
            var extraInfo = await GetExtraStateInfoAsync(
                eventData.SettlementAccountId,
                eventData.ContractBaseId);
