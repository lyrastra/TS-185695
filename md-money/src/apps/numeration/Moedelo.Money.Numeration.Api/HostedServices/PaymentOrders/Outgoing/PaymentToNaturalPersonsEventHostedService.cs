...
public class PaymentToNaturalPersonsEventHostedService : BackgroundService
{
    ...
    public PaymentToNaturalPersonsEventHostedService(
        ILogger<PaymentToNaturalPersonsEventHostedService> logger,
    ...
    private async Task OnCreated(PaymentToNaturalPersonsCreated eventData)
    {
