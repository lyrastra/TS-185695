...
public class BankFeeEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly IBankFeeEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public BankFeeEventHostedService(
        ILogger<BankFeeEventHostedService> logger,
    ...
    private async Task OnCreated(BankFeeCreated eventData)
    {
