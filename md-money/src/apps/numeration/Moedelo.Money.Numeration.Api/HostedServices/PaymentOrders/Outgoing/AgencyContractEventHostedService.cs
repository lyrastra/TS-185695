...
public class AgencyContractEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly IAgencyContractEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public AgencyContractEventHostedService(
        ILogger<AgencyContractEventHostedService> logger,
    ...
    private async Task OnCreated(AgencyContractCreated eventData)
    {
