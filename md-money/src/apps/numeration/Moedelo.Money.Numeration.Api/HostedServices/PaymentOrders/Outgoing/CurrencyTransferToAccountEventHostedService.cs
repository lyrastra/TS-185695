...
public class CurrencyTransferToAccountEventHostedService : BackgroundService
{
    ...
    public CurrencyTransferToAccountEventHostedService(
        ILogger<CurrencyTransferToAccountEventHostedService> logger,
    ...
    private async Task OnCreated(CurrencyTransferToAccountCreatedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
    ...
    private Task OnUpdated(CurrencyTransferToAccountUpdatedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
        return Task.CompletedTask;
    }

    private Task OnDeleted(CurrencyTransferToAccountDeletedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
        return Task.CompletedTask;
    }
}