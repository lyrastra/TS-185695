...
public class RefundToCustomerEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly IRefundToCustomerEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public RefundToCustomerEventHostedService(
        ILogger<RefundToCustomerEventHostedService> logger,
    ...
    private async Task OnCreated(RefundToCustomerCreated eventData)
    {
