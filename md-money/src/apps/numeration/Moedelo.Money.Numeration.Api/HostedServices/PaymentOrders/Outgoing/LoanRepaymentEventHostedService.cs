...
public class LoanRepaymentEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly ILoanRepaymentEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public LoanRepaymentEventHostedService(
        ILogger<LoanRepaymentEventHostedService> logger,
    ...
    private async Task OnCreated(LoanRepaymentCreated eventData)
    {
