...
public class WithdrawalOfProfitEventHostedService : BackgroundService
{
    ...
    public WithdrawalOfProfitEventHostedService(
        ILogger<WithdrawalOfProfitEventHostedService> logger,
    ...
    private async Task OnCreated(WithdrawalOfProfitCreated eventData)
    {
