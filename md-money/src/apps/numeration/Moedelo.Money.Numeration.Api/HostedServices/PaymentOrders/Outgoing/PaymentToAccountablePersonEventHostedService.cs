...
public class PaymentToAccountablePersonEventHostedService : BackgroundService
{
    ...
    public PaymentToAccountablePersonEventHostedService(
        ILogger<PaymentToAccountablePersonEventHostedService> logger,
    ...
    private async Task OnCreated(PaymentToAccountablePersonCreated eventData)
    {
