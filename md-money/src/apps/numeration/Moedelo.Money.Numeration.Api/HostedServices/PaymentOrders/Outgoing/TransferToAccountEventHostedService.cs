...
public class TransferToAccountEventHostedService : BackgroundService
{
    ...
    public TransferToAccountEventHostedService(
        ILogger<TransferToAccountEventHostedService> logger,
    ...
    private async Task OnCreated(TransferToAccountCreated eventData)
    {
