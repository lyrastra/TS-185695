...
public class LoanIssueEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly ILoanIssueEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public LoanIssueEventHostedService(
        ILogger<LoanIssueEventHostedService> logger,
    ...
    private async Task OnCreated(LoanIssueCreated eventData)
    {
