...
public class OutgoingCurrencyPurchaseEventHostedService : BackgroundService
{
    ...
    public OutgoingCurrencyPurchaseEventHostedService(
        ILogger<OutgoingCurrencyPurchaseEventHostedService> logger,
    ...
    private async Task OnCreated(OutgoingCurrencyPurchaseCreated eventData)
    {
