...
public class PaymentToSupplierEventHostedService : BackgroundService
{
    ...
    public PaymentToSupplierEventHostedService(
        ILogger<PaymentToSupplierEventHostedService> logger,
    ...
    private async Task OnCreated(PaymentToSupplierCreated eventData)
    {
