...
public class DeductionEventHostedService : BackgroundService
{
    private readonly ILogger logger;
    private readonly IDeductionEventReaderBuilder eventReaderBuilder;
    private readonly INumberSetter numberSetter;

    public DeductionEventHostedService(
        ILogger<DeductionEventHostedService> logger,
    ...
    private async Task OnCreated(DeductionCreated eventData)
    {
