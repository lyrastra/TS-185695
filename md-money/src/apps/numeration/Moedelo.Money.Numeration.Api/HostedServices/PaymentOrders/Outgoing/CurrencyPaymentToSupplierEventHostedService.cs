...
public class CurrencyPaymentToSupplierEventHostedService : BackgroundService
{
    ...
    public CurrencyPaymentToSupplierEventHostedService(
        ILogger<CurrencyPaymentToSupplierEventHostedService> logger,
    ...
    private async Task OnCreated(CurrencyPaymentToSupplierCreatedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
    ...
    private Task OnUpdated(CurrencyPaymentToSupplierUpdatedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
        return Task.CompletedTask;
    }

    private Task OnDeleted(CurrencyPaymentToSupplierDeletedMessage eventData, KafkaMessageValueMetadata valueMetadata)
    {
        return Task.CompletedTask;
    }
}