...
namespace Moedelo.Money.Providing.Business.AccountingStatements.PaymentForDocuments.Incoming
{
    internal static class IncomingPaymentForDocumentsGenerator
    {
        const ushort envdStopYear = 2021;
        internal static PaymentForDocumentsGenerateResult[] Generate(IncomingPaymentForDocumentsGenerateRequest data)
        {
        ...
        private static PaymentForDocumentsGenerateResult GetByWaybill(
            SalesWaybill waybill,
            DocumentLink link,
            IncomingPaymentForDocumentsGenerateRequest data)
        {
            if (link == null)
            {
            ...
            if (!SyntheticAccountCode._62.ContainsSubaccount(waybill.KontragentAccountCode))
            {
                return null;
            }
        ...
        private static PaymentForDocumentsGenerateResult GetByStatement(
            ...
            IncomingPaymentForDocumentsGenerateRequest data)
        {
            ...
            if (!SyntheticAccountCode._62.ContainsSubaccount(statement.KontragentAccountCode))
            {
                return null;
            }
        ...
        private static PaymentForDocumentsGenerateResult GetByUpd(
            SalesUpd upd,
            DocumentLink link,
            IncomingPaymentForDocumentsGenerateRequest data)
        {
            ...
            if (!SyntheticAccountCode._62.ContainsSubaccount(upd.KontragentAccountCode))
            {
                return null;
            }
        ...
        private static AccountingPosting CreateAccPosting(decimal sum, string description, Kontragent kontragent, Contract contract)
        {
            ...
            {
                Sum = sum,
                DebitCode = SyntheticAccountCode._62_02,
                CreditCode = SyntheticAccountCode._62_01,
