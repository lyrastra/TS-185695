...
{
    public interface IUnifiedBudgetaryPaymentKbkDefaultsReader
    {
        Task<BudgetaryKbkDefaultsResponse> GetAsync(UnifiedBudgetaryPaymentKbkDefaultsRequest request);
    }
}
