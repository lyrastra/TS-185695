...
{
    public class PaymentOrderSnapshotResponse
    {
        /// <summary> Реквизиты плательщика </summary>
        public OrderDetailsResponse Payer { get; set; }

        /// <summary>  Реквизиты получателя платежа  </summary>
        public OrderDetailsResponse Recipient { get; set; }
        ...
        public BudgetaryPeriodResponse BudgetaryPeriod { get; set; }
