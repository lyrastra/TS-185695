...
{
    public class RefundToSettlementAccountSaveRequest : IPaymentOrderOutsourceSaveRequest
    {
        ...
        public RefundToSettlementAccountCustomAccPosting AccPosting { get; set; }
