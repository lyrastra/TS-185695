...
namespace Moedelo.Money.Domain.PaymentOrders.Incoming.FinancialAssistance
{
    public class FinancialAssistanceSaveRequest : IPaymentOrderOutsourceSaveRequest
    {
