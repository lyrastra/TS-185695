...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/CurrencyOtherIncoming/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceCurrencyOtherIncomingController : ControllerBase
{
    private readonly ICurrencyOtherIncomingOutsourceProcessor processor;

    public OutsourceCurrencyOtherIncomingController(ICurrencyOtherIncomingOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmCurrencyOtherIncomingDto request)
    {
