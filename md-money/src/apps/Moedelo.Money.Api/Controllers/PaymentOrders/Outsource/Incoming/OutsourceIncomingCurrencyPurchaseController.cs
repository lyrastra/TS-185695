...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/CurrencyPurchase/Outsource")]
public class OutsourceIncomingCurrencyPurchaseController : ControllerBase
{
    private readonly IIncomingCurrencyPurchaseOutsourceProcessor processor;

    public OutsourceIncomingCurrencyPurchaseController(IIncomingCurrencyPurchaseOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmIncomingCurrencyPurchaseDto request)
    {
