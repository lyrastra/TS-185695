...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/FinancialAssistance/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceFinancialAssistanceController : ControllerBase
{
    private readonly IFinancialAssistanceOutsourceProcessor processor;

    public OutsourceFinancialAssistanceController(IFinancialAssistanceOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmFinancialAssistanceDto request)
    {
