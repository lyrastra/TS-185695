...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/RefundToSettlementAccount/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceRefundToSettlementAccountController : ControllerBase
{
    private readonly IRefundToSettlementAccountOutsourceProcessor processor;

    public OutsourceRefundToSettlementAccountController(IRefundToSettlementAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmRefundToSettlementAccountDto request)
    {
