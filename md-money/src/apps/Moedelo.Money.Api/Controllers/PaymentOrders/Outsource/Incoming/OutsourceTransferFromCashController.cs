...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/TransferFromCash/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]

public class OutsourceTransferFromCashController : ControllerBase
{
    private readonly ITransferFromCashOutsourceProcessor processor;

    public OutsourceTransferFromCashController(ITransferFromCashOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmTransferFromCashDto request)
    {
