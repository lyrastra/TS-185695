...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/CurrencyTransferFromAccount/Outsource")]
public class OutsourceCurrencyTransferFromAccountController : ControllerBase
{
    private readonly ICurrencyTransferFromAccountOutsourceProcessor processor;

    public OutsourceCurrencyTransferFromAccountController(ICurrencyTransferFromAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmCurrencyTransferFromAccountDto request)
    {
