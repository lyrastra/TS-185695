...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/PaymentFromCustomer/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourcePaymentFromCustomerController : ControllerBase
{
    private readonly IPaymentFromCustomerOutsourceProcessor processor;

    public OutsourcePaymentFromCustomerController(IPaymentFromCustomerOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmPaymentFromCustomerDto request)
    {
