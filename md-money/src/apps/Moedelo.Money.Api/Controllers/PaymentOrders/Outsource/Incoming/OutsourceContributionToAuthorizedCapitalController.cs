...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/ContributionToAuthorizedCapital/Outsource")]
public class OutsourceContributionToAuthorizedCapitalController : ControllerBase
{
    private readonly IContributionToAuthorizedCapitalOutsourceProcessor processor;

    public OutsourceContributionToAuthorizedCapitalController(IContributionToAuthorizedCapitalOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmContributionToAuthorizedCapitalDto request)
    {
