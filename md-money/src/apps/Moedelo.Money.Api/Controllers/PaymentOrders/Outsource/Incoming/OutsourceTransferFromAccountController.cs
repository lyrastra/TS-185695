...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/TransferFromAccount/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceTransferFromAccountController : ControllerBase
{
    private readonly ITransferFromAccountOutsourceProcessor processor;

    public OutsourceTransferFromAccountController(ITransferFromAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmTransferFromAccountDto request)
    {
