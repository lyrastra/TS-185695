...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/AccrualOfInterest/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceAccrualOfInterestController : ControllerBase
{
    private readonly IAccrualOfInterestOutsourceProcessor processor;

    public OutsourceAccrualOfInterestController(IAccrualOfInterestOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmAccrualOfInterestDto request)
    {
