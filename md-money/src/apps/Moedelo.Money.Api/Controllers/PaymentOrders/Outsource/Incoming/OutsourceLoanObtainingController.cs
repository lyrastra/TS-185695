...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/LoanObtaining/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceLoanObtainingController : ControllerBase
{
    private readonly ILoanObtainingOutsourceProcessor processor;

    public OutsourceLoanObtainingController(ILoanObtainingOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmLoanObtainingDto request)
    {
