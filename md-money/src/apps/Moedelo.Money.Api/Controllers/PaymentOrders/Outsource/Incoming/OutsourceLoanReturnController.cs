...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/LoanReturn/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceLoanReturnController : ControllerBase
{
    private readonly ILoanReturnOutsourceProcessor processor;

    public OutsourceLoanReturnController(ILoanReturnOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmLoanReturnDto request)
    {
