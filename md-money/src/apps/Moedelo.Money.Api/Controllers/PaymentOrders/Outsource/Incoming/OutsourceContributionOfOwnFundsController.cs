...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/ContributionOfOwnFunds/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceContributionOfOwnFundsController : ControllerBase
{
    private readonly IContributionOfOwnFundsOutsourceProcessor processor;

    public OutsourceContributionOfOwnFundsController(IContributionOfOwnFundsOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmContributionOfOwnFundsDto request)
    {
