...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/CurrencySale/Outsource")]
public class OutsourceIncomingCurrencySaleController : ControllerBase
{
    private readonly IIncomingCurrencySaleOutsourceProcessor processor;

    public OutsourceIncomingCurrencySaleController(IIncomingCurrencySaleOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmIncomingCurrencySaleDto request)
    {
