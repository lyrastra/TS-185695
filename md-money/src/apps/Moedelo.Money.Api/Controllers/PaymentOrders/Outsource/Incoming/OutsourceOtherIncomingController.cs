...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/OtherIncoming/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceOtherIncomingController : ControllerBase
{
    private readonly IOtherIncomingOutsourceProcessor processor;

    public OutsourceOtherIncomingController(IOtherIncomingOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmOtherIncomingDto request)
    {
