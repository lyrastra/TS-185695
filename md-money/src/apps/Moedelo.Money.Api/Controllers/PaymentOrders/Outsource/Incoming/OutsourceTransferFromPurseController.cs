...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/TransferFromPurse/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceTransferFromPurseController : ControllerBase
{
    private readonly ITransferFromPurseOutsourceProcessor processor;

    public OutsourceTransferFromPurseController(ITransferFromPurseOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmTransferFromPurseDto request)
    {
