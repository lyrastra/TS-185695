...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Incoming/RetailRevenue/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceRetailRevenueController : ControllerBase
{
    private readonly IRetailRevenueOutsourceProcessor processor;

    public OutsourceRetailRevenueController(IRetailRevenueOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmRetailRevenueDto request)
    {
