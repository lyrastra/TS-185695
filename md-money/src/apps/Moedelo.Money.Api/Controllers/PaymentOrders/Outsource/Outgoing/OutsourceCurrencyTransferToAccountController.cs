...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/CurrencyTransferToAccount/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceCurrencyTransferToAccountController : ControllerBase
{
    private readonly ICurrencyTransferToAccountOutsourceProcessor processor;

    public OutsourceCurrencyTransferToAccountController(ICurrencyTransferToAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmCurrencyTransferToAccountDto request)
    {
