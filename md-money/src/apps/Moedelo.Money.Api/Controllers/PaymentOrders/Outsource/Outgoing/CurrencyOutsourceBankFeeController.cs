...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/CurrencyBankFee/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceCurrencyBankFeeController : ControllerBase
{
    private readonly ICurrencyBankFeeOutsourceProcessor processor;

    public OutsourceCurrencyBankFeeController(ICurrencyBankFeeOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmCurrencyBankFeeDto request)
    {
