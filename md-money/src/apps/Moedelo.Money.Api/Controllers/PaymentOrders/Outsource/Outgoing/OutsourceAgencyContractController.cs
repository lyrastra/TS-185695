...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/AgencyContract/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceAgencyContractController : ControllerBase
{
    private readonly IAgencyContractOutsourceProcessor processor;

    public OutsourceAgencyContractController(IAgencyContractOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmAgencyContractDto request)
    {
