...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/CurrencyOtherOutgoing/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceCurrencyOtherOutgoingController : ControllerBase
{
    private readonly ICurrencyOtherOutgoingOutsourceProcessor processor;

    public OutsourceCurrencyOtherOutgoingController(ICurrencyOtherOutgoingOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmCurrencyOtherOutgoingDto request)
    {
