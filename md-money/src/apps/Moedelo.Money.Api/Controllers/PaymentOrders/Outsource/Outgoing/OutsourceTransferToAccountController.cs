...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/TransferToAccount/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceTransferToAccountController : ControllerBase
{
    private readonly ITransferToAccountOutsourceProcessor processor;

    public OutsourceTransferToAccountController(ITransferToAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmTransferToAccountDto request)
    {
