...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/Deduction/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceDeductionController : ControllerBase
{
    private readonly IDeductionOutsourceProcessor processor;

    public OutsourceDeductionController(IDeductionOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmDeductionDto request)
    {
