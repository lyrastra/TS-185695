...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/RentPayment/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceRentPaymentController : ControllerBase
{
    private readonly IRentPaymentOutsourceProcessor processor;

    public OutsourceRentPaymentController(IRentPaymentOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmRentPaymentDto request)
    {
