...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/PaymentToSupplier/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourcePaymentToSupplierController : ControllerBase
{
    private readonly IPaymentToSupplierOutsourceProcessor processor;

    public OutsourcePaymentToSupplierController(IPaymentToSupplierOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmPaymentToSupplierDto request)
    {
