...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/WithdrawalOfProfit/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceWithdrawalOfProfitController : ControllerBase
{
    private readonly IWithdrawalOfProfitOutsourceProcessor processor;

    public OutsourceWithdrawalOfProfitController(IWithdrawalOfProfitOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmWithdrawalOfProfitDto request)
    {
