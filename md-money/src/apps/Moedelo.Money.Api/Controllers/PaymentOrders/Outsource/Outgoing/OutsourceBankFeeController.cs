...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/BankFee/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceBankFeeController : ControllerBase
{
    private readonly IBankFeeOutsourceProcessor processor;

    public OutsourceBankFeeController(IBankFeeOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmBankFeeDto request)
    {
