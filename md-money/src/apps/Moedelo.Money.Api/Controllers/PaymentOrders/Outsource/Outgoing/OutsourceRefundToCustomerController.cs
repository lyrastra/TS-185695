...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/RefundToCustomer/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceRefundToCustomerController : ControllerBase
{
    private readonly IRefundToCustomerOutsourceProcessor processor;

    public OutsourceRefundToCustomerController(IRefundToCustomerOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmRefundToCustomerDto request)
    {
