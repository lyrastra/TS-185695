...
[ApiController]
[ApiVersion("1")]
[Route("private/api/v{version:apiVersion}/PaymentOrders/Outgoing/WithdrawalFromAccount/Outsource")]
[ApiExplorerSettings(IgnoreApi = true)]
public class OutsourceWithdrawalFromAccountController : ControllerBase
{
    private readonly IWithdrawalFromAccountOutsourceProcessor processor;

    public OutsourceWithdrawalFromAccountController(IWithdrawalFromAccountOutsourceProcessor processor)
    {
    ...
    public async Task<IActionResult> ConfirmAsync(ConfirmWithdrawalFromAccountDto request)
    {
