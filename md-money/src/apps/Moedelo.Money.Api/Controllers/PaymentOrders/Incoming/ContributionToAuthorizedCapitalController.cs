...
namespace Moedelo.Money.Api.Controllers.PaymentOrders.Incoming
{
    ...
    public class ContributionToAuthorizedCapitalController : ControllerBase
    {
        ...
        private readonly IContributionToAuthorizedCapitalRemover remover;
        ...
        public ContributionToAuthorizedCapitalController(
            ...
            IContributionToAuthorizedCapitalRemover remover)
        {
        ...
        [ProducesResponseType(200, Type = typeof(ApiDataResponseDto<ContributionToAuthorizedCapitalResponseDto>))]
        [SwaggerOperation(Tags = new[] { "Деньги/Банк/Поступления - Взнос в уставный капитал" })]
        public async Task<IActionResult> GetAsync(long documentBaseId)
        {
            ...
            var responseDto = ContributionToAuthorizedCapitalMapper.Map(response);
        ...
        [SwaggerOperation(Tags = new[] { "Деньги/Банк/Поступления - Взнос в уставный капитал" })]
        public async Task<IActionResult> CreateAsync(ContributionToAuthorizedCapitalSaveDto saveDto)
        {
            var saveRequest = ContributionToAuthorizedCapitalMapper.Map(saveDto);
        ...
        [SwaggerOperation(Tags = new[] { "Деньги/Банк/Поступления - Взнос в уставный капитал" })]
        public async Task<IActionResult> UpdateAsync(long documentBaseId, ContributionToAuthorizedCapitalSaveDto saveDto)
        {
            var saveRequest = ContributionToAuthorizedCapitalMapper.Map(saveDto);
