...
{
    /// <summary>
    /// Операция "Выплата по агентскому договору"
    /// </summary>
    public class AgencyContractResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        public OperationType OperationType => OperationType.PaymentOrderOutgoingAgencyContract;
