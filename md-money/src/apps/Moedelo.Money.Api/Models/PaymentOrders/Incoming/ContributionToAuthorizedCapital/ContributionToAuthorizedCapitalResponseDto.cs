...
namespace Moedelo.Money.Api.Models.PaymentOrders.Incoming.ContributionToAuthorizedCapital
{
    ...
    /// Операция "Взнос в УК"
    /// </summary>
    public class ContributionToAuthorizedCapitalResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        public OperationType OperationType => OperationType.PaymentOrderIncomingContributionToAuthorizedCapital;
