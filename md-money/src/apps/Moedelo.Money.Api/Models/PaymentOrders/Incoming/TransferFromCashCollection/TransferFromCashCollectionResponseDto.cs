...
{
    /// <summary>
    /// Операция "Инкассированные денежные средства"
    /// </summary>
    public class TransferFromCashCollectionResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        public OperationType OperationType => OperationType.MemorialWarrantTransferFromCashCollection;
