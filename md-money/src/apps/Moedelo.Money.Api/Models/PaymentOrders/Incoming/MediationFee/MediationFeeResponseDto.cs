...
{
    /// <summary>
    /// Операция "Посредническое вознаграждение"
    /// </summary>
    public class MediationFeeResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        public OperationType OperationType = OperationType.PaymentOrderIncomingMediationFee;
