...
{
    /// <summary>
    /// Операция "Возврат от подотчетного лица"
    /// </summary>
    public class RefundFromAccountablePersonResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        /// Авансовый отчет
        /// </summary>
        public RemoteServiceResponseDto<AdvanceStatementResponseDto> AdvanceStatement { get; set; }
        ...
        public OperationType OperationType => OperationType.PaymentOrderIncomingRefundFromAccountablePerson;
