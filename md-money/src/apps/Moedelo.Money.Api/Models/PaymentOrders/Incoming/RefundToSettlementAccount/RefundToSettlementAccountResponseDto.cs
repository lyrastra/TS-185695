...
namespace Moedelo.Money.Api.Models.PaymentOrders.Incoming.RefundToSettlementAccount
{
    /// <summary>
    /// Операция "Поступления - Возврат на расчётный счет"
    /// </summary>
    public class RefundToSettlementAccountResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        // <summary> 
        // Связанные счета Поле из прочего поступления для Возврата на расчетный счет пока сокрыто
        // </summary>
        //public RemoteServiceResponseDto<IReadOnlyCollection<BillLinkDto>> Bills { get; set; }

        public OperationType OperationType => OperationType.PaymentOrderIncomingRefundToSettlementAccount;
        ...
        // <summary>
        // В том числе НДС Поле из прочего поступления для Возврата на расчетный счет пока сокрыто
        // </summary>
