...
{
    /// <summary>
    /// Модель для сохранения операции "Поступления - Возврат на расчётный счет"
    /// </summary>
    public class RefundToSettlementAccountSaveDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        // <summary>
        // НДС Поле из прочего поступления для Возврата на расчетный счет пока сокрыто
        // </summary>
