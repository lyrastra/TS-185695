...
{
    /// <summary>
    /// Операция "Поступление от комиссионера"
    /// </summary>
    public class IncomeFromCommissionAgentResponseDto
    {
        /// <summary>
        /// Дата документа
        /// </summary>
        ...
        public OperationType OperationType = OperationType.PaymentOrderIncomingIncomeFromCommissionAgent;
