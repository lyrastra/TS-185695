...
namespace Moedelo.Money.Api.Models.PaymentOrders.Incoming.LoanReturn
{
    /// <summary>
    /// Операция "Возврат займа или процентов"
    /// </summary>
    public class LoanReturnResponseDto
    {
        ...
        public OperationType OperationType => OperationType.PaymentOrderIncomingLoanReturn;
