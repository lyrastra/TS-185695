...
{
    [InjectAsSingleton(typeof(IOutgoingCurrencySaleImporter))]
    internal sealed class OutgoingCurrencySaleImporter : IOutgoingCurrencySaleImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly OutgoingCurrencySaleImportValidator validator;
        ...
        public OutgoingCurrencySaleImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            OutgoingCurrencySaleImportValidator validator,
        ...
        public async Task ImportAsync(OutgoingCurrencySaleImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = OutgoingCurrencySaleMapper.MapToSaveRequest(request);
