...
internal class PaymentToAccountablePersonDetailUpdater :
    ConcretePaymentDetailUpdaterBase<PaymentToAccountablePersonResponse, PaymentToAccountablePersonSaveRequest, PaymentOrderSaveResponse>
{
    public PaymentToAccountablePersonDetailUpdater(
    ...
    protected override async Task DetailUpdateAsync(PaymentToAccountablePersonSaveRequest saveRequest, ChangeIsPaidRequestItem item)
    {
