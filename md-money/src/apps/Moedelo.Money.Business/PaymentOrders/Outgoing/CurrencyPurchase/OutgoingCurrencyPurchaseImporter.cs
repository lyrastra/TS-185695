...
{
    [InjectAsSingleton(typeof(IOutgoingCurrencyPurchaseImporter))]
    internal sealed class OutgoingCurrencyPurchaseImporter : IOutgoingCurrencyPurchaseImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly OutgoingCurrencyPurchaseImportValidator validator;
        ...
        public OutgoingCurrencyPurchaseImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            OutgoingCurrencyPurchaseImportValidator validator,
        ...
        public async Task ImportAsync(OutgoingCurrencyPurchaseImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = OutgoingCurrencyPurchaseMapper.MapToSaveRequest(request);
