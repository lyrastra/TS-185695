...
{
    [InjectAsSingleton(typeof(UnifiedBudgetaryPaymentTaxPostingsValidator))]
    class UnifiedBudgetaryPaymentTaxPostingsValidator : TaxPostingsValidator
    {
        public UnifiedBudgetaryPaymentTaxPostingsValidator(
