...
namespace Moedelo.Money.Business.PaymentOrders.Outgoing.LoanRepayment
{
    ...
    {
        internal static BaseDocumentCreateRequest MapToBaseDocumentCreateRequest(LoanRepaymentSaveRequest request)
        {
        ...
        internal static LoanRepaymentDto MapToDto(LoanRepaymentSaveRequest request)
        {
        ...
        internal static LoanRepaymentResponse MapToResponse(LoanRepaymentDto dto)
        {
        ...
        internal static LoanRepaymentSaveRequest MapToSaveRequest(LoanRepaymentResponse response)
        {
        ...
        internal static LoanRepaymentSaveRequest MapToSaveRequest(LoanRepaymentImportRequest request)
        {
            return new LoanRepaymentSaveRequest
            {
                Date = request.Date,
        ...
        internal static LoanRepaymentCreated MapToCreatedMessage(LoanRepaymentSaveRequest request)
        {
            return new LoanRepaymentCreated
            {
                DocumentBaseId = request.DocumentBaseId,
                Date = request.Date,
                Number = request.Number,
        ...
        internal static LoanRepaymentUpdated MapToUpdatedMessage(LoanRepaymentSaveRequest request)
        {
            return new LoanRepaymentUpdated
            {
                DocumentBaseId = request.DocumentBaseId,
                Date = request.Date,
                Number = request.Number,
        ...
        internal static LoanRepaymentProvideRequired MapToProvideRequired(LoanRepaymentResponse response)
        {
            return new LoanRepaymentProvideRequired
            {
                DocumentBaseId = response.DocumentBaseId,
                Date = response.Date,
                Number = response.Number,
        ...
        internal static LoanRepaymentDeleted MapToDeleted(LoanRepaymentResponse response, long? newDocumentBaseId)
        {
            return new LoanRepaymentDeleted
            {
                DocumentBaseId = response.DocumentBaseId,
                Date = response.Date,
                Number = response.Number,
        ...
        internal static CustomTaxPostingsOverwriteRequest MapToCustomTaxPostingsOverwriteRequest(
            LoanRepaymentSaveRequest request)
        {
