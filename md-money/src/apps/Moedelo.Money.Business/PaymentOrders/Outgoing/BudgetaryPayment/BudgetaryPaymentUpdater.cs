...
namespace Moedelo.Money.Business.PaymentOrders.Outgoing.BudgetaryPayment
{
    ...
    internal sealed class BudgetaryPaymentUpdater : IBudgetaryPaymentUpdater
    {
        private readonly OperationType OperationType = OperationType.BudgetaryPayment;
        ...
        public async Task<PaymentOrderSaveResponse> UpdateAsync(BudgetaryPaymentSaveRequest request)
        {
            try
            {
        ...
        private async Task RecreateOperationAsync(BudgetaryPaymentSaveRequest request, OperationType oldOperationType)
        {
        ...
        private async Task UpdateOperationAsync(BudgetaryPaymentSaveRequest request)
        {
