...
{
    [InjectAsSingleton(typeof(ITransferFromPurseImporter))]
    internal sealed class TransferFromPurseImporter : ITransferFromPurseImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly TransferFromPurseImportValidator validator;
        private readonly ITransferFromPurseCreator creator;
        private readonly PaymentOrderImportEventNotifier importEventNotifier;

        public TransferFromPurseImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            TransferFromPurseImportValidator validator,
        ...
        public async Task ImportAsync(TransferFromPurseImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = TransferFromPurseMapper.MapToSaveRequest(request);
