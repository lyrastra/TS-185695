...
{
    [InjectAsSingleton(typeof(LoanReturnLinksGetter))]
    internal sealed class LoanReturnLinksGetter
    {
        private readonly ILogger logger;
        private readonly ILinksReader linksReader;
        private readonly IContractsReader contractsReader;

        public LoanReturnLinksGetter(
            ILogger<LoanReturnLinksGetter> logger,
