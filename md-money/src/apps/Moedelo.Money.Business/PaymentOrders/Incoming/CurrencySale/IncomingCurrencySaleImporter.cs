...
{
    [InjectAsSingleton(typeof(IIncomingCurrencySaleImporter))]
    internal sealed class IncomingCurrencySaleImporter : IIncomingCurrencySaleImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly IncomingCurrencySaleImportValidator validator;
        ...
        public IncomingCurrencySaleImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            IncomingCurrencySaleImportValidator validator,
        ...
        public async Task ImportAsync(IncomingCurrencySaleImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = IncomingCurrencySaleMapper.MapToSaveRequest(request);
