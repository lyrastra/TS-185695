...
{
    [InjectAsSingleton(typeof(CurrencyOtherIncomingLinksGetter))]
    internal sealed class CurrencyOtherIncomingLinksGetter
    {
        private readonly ILogger logger;
        private readonly ILinksReader linksReader;
        private readonly IContractsReader contractsReader;

        public CurrencyOtherIncomingLinksGetter(
            ILogger<CurrencyOtherIncomingLinksGetter> logger,
        ...
        public async Task<CurrencyOtherIncomingLinks> GetAsync(long documentBaseId)
        {
            try
            {
                ...
                return new CurrencyOtherIncomingLinks
                {
                    Contract = contract
                };
            }
