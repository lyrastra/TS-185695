...
{
    [InjectAsSingleton(typeof(ILoanObtainingImporter))]
    internal sealed class LoanObtainingImporter : ILoanObtainingImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly LoanObtainingImportValidator validator;
        private readonly ILoanObtainingCreator creator;
        private readonly PaymentOrderImportEventNotifier importEventNotifier;

        public LoanObtainingImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            LoanObtainingImportValidator validator,
        ...
        public async Task ImportAsync(LoanObtainingImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = LoanObtainingMapper.MapToSaveRequest(request);
