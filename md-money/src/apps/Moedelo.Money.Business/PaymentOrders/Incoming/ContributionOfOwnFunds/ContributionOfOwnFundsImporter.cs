...
{
    [InjectAsSingleton(typeof(IContributionOfOwnFundsImporter))]
    internal sealed class ContributionOfOwnFundsImporter : IContributionOfOwnFundsImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly ContributionOfOwnFundsImportValidator validator;
        ...
        public ContributionOfOwnFundsImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            ContributionOfOwnFundsImportValidator validator,
        ...
        public async Task ImportAsync(ContributionOfOwnFundsImportRequest request)
        {
            ...
            try
            {
                ...
                var saveRequest = ContributionOfOwnFundsMapper.MapToSaveRequest(request);
