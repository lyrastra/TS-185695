...
{
    [InjectAsSingleton(typeof(ICurrencyPaymentFromCustomerImporter))]
    internal sealed class CurrencyPaymentFromCustomerImporter : ICurrencyPaymentFromCustomerImporter
    {
        private readonly ImportAvailabilityChecker importAvailabilityChecker;
        private readonly CurrencyPaymentFromCustomerImportValidator validator;
        ...
        public CurrencyPaymentFromCustomerImporter(
            ImportAvailabilityChecker importAvailabilityChecker,
            CurrencyPaymentFromCustomerImportValidator validator,
        ...
        public async Task ImportAsync(CurrencyPaymentFromCustomerImportRequest request)
        {
            ...
            try
            {
                ...
                CurrencyPaymentFromCustomerSaveRequest saveRequest = CurrencyPaymentFromCustomerMapper.MapToSaveRequest(request);
