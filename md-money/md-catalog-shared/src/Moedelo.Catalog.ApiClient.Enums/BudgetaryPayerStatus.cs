namespace Moedelo.Catalog.ApiClient.Enums
{
    public enum BudgetaryPayerStatus
    {
        ...
        /// <summary> 23. Органы контроля за уплатой страховых взносов. </summary>
        InsuranceControl = 23,

        /// <summary> 24. физическое лицо, осуществляющее перевод денежных средств в уплату страховых взносов и иных платежей в бюджетную систему РФ </summary>
