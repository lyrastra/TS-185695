...
namespace Moedelo.Money.Kafka.PurseOperations.Outgoing.TransferToSettlementAccount
{
    ...
    class TransferToSettlementAccountEventReaderBuilder : MoedeloEntityEventKafkaTopicReaderBuilder, ITransferToSettlementAccountEventReaderBuilder
    {
        public TransferToSettlementAccountEventReaderBuilder(
            ...
            : base(
                MoneyTopics.PurseOperations.TransferToSettlementAccount.Event.Topic,
                MoneyTopics.PurseOperations.TransferToSettlementAccount.EntityName,
                reader,
                contextInitializer,
                contextAccessor,
                auditTracer)
