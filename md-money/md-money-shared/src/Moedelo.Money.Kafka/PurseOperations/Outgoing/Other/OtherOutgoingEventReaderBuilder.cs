...
namespace Moedelo.Money.Kafka.PurseOperations.Outgoing.Other
{
    ...
    class OtherOutgoingEventReaderBuilder : MoedeloEntityEventKafkaTopicReaderBuilder, IOtherOutgoingEventReaderBuilder
    {
        public OtherOutgoingEventReaderBuilder(
            ...
            : base(
                MoneyTopics.PurseOperations.OtherOutgoing.Event.Topic,
                MoneyTopics.PurseOperations.OtherOutgoing.EntityName,
                reader,
                contextInitializer,
                contextAccessor,
                auditTracer)
