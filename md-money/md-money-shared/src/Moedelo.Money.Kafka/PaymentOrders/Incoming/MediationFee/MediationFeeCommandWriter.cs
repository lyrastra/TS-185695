...
{
    [InjectAsSingleton(typeof(IMediationFeeCommandWriter))]
    internal sealed class MediationFeeCommandWriter : IMediationFeeCommandWriter
    {
        private const string EntityName = MoneyTopics.PaymentOrders.MediationFee.EntityName;
        private static readonly string Topic = MoneyTopics.PaymentOrders.MediationFee.Command.Topic;
        ...
        public MediationFeeCommandWriter(
        ...
        public Task WriteImportAsync(
            ImportMediationFee commandData)
        {
        ...
        public Task WriteImportDuplicateAsync(
            ImportDuplicateMediationFee commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteImportWithMissingContractAsync(
            ImportWithMissingContractMediationFee commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteImportWithMissingContractorAsync(
            ImportWithMissingContractorMediationFee commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
