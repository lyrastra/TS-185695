...
{
    [InjectAsSingleton(typeof(ICurrencyTransferFromAccountEventReader))]
    internal sealed class CurrencyTransferFromAccountEventReader : MoedeloKafkaTopicReaderBase, ICurrencyTransferFromAccountEventReader
    {
        public CurrencyTransferFromAccountEventReader(
            IMoedeloKafkaTopicReaderBaseDependencies dependencies,
            ILogger<CurrencyTransferFromAccountEventReader> logger)
            : base(
                dependencies,
                logger)
        {
        ...
        public Task ReadAsync(string groupId,
            Func<CurrencyTransferFromAccountCreatedMessage, KafkaMessageValueMetadata, Task> onCreate,
            Func<CurrencyTransferFromAccountUpdatedMessage, KafkaMessageValueMetadata, Task> onUpdate,
            Func<CurrencyTransferFromAccountDeletedMessage, KafkaMessageValueMetadata, Task> onDelete,
            ...
            CancellationToken? cancellationToken = null)
        {
            ...
            Task OnMessageAction(CUDEventMessageValue messageValue)
            {
                ...
                switch (messageValue.EventType)
                {
                    case CUDEventType.Created:
                        var createdMessage =
                            messageValue.EventDataJson.FromJsonString<CurrencyTransferFromAccountCreatedMessage>();
                        return onCreate(createdMessage, metadata);
                    case CUDEventType.Updated:
                        var updatedMessage =
                            messageValue.EventDataJson.FromJsonString<CurrencyTransferFromAccountUpdatedMessage>();
                        return onUpdate(updatedMessage, metadata);
                    case CUDEventType.Deleted:
                        var deletedMessage =
                            messageValue.EventDataJson.FromJsonString<CurrencyTransferFromAccountDeletedMessage>();
            ...
            var topicName = PaymentOrderTopics.CurrencyTransferFromAccount.Event.CUD;
