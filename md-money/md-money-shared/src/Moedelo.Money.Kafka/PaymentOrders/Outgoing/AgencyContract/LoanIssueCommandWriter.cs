...
{
    [InjectAsSingleton(typeof(IAgencyContractCommandWriter))]
    internal sealed class AgencyContractCommandWriter : IAgencyContractCommandWriter
    {
        private const string EntityName = MoneyTopics.PaymentOrders.AgencyContract.EntityName;
        private static readonly string Topic = MoneyTopics.PaymentOrders.AgencyContract.Command.Topic;
        ...
        public AgencyContractCommandWriter(
        ...
        public Task WriteImportAsync(
            ImportAgencyContract commandData)
        {
        ...
        public Task WriteImportDuplicateAsync(
            ImportDuplicateAgencyContract commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteImportWithMissingContractAsync(
            ImportWithMissingContractAgencyContract commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteImportWithMissingContractorAsync(
            ImportWithMissingContractorAgencyContract commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
