...
{
    [InjectAsSingleton(typeof(IPaymentToSupplierCommandWriter))]
    internal sealed class PaymentToSupplierCommandWriter : IPaymentToSupplierCommandWriter
    {
        private const string EntityName = MoneyTopics.PaymentOrders.PaymentToSupplier.EntityName;
        private static readonly string Topic = MoneyTopics.PaymentOrders.PaymentToSupplier.Command.Topic;
        ...
        public Task WriteApplyIgnoreNumberAsync(ApplyIgnoreNumberPaymentToSupplier commandData)
        {
