...
{
    [InjectAsSingleton(typeof(ICurrencyBankFeeCommandWriter))]
    internal sealed class CurrencyBankFeeCommandWriter : ICurrencyBankFeeCommandWriter
    {
        private const string EntityName = MoneyTopics.PaymentOrders.CurrencyBankFee.EntityName;
        private static readonly string Topic = MoneyTopics.PaymentOrders.CurrencyBankFee.Command.Topic;
