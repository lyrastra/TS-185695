...
{
    [InjectAsSingleton(typeof(IWithdrawalOfProfitCommandWriter))]
    internal sealed class WithdrawalOfProfitCommandWriter : IWithdrawalOfProfitCommandWriter
    {
        private const string EntityName = MoneyTopics.PaymentOrders.WithdrawalOfProfit.EntityName;
        private static readonly string Topic = MoneyTopics.PaymentOrders.WithdrawalOfProfit.Command.Topic;
        ...
        public Task WriteImportAsync(ImportWithdrawalOfProfit commandData)
        {
        ...
        public Task WriteImportDuplicateAsync(ImportDuplicateWithdrawalOfProfit commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteImportWithMissingContractorAsync(ImportWithMissingContractorWithdrawalOfProfit commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
        ...
        public Task WriteApplyIgnoreNumberAsync(ApplyIgnoreNumberWithdrawalOfProfit commandData)
        {
            var context = executionInfoContextAccessor.ExecutionInfoContext;
            var commandDefinition = definitionBuilder.CreateCommandDefinition(context.FirmId.ToString(), commandData);
            return commandKafkaTopicWriter.WriteCommandDataAsync(commandDefinition);
