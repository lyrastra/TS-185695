...
namespace Moedelo.Money.Kafka.PaymentOrders.Outgoing.WithdrawalOfProfit
{
    ...
    public class WithdrawalOfProfitEventReaderBuilder : MoedeloEntityEventKafkaTopicReaderBuilder, IWithdrawalOfProfitEventReaderBuilder
    {
        public WithdrawalOfProfitEventReaderBuilder(
            ...
            : base(
                  MoneyTopics.PaymentOrders.WithdrawalOfProfit.Event.Topic,
        ...
        public IWithdrawalOfProfitEventReaderBuilder OnProvideRequired(Func<WithdrawalOfProfitProvideRequired, Task> onEvent)
        {
            OnEvent(onEvent);
            return this;
        }
