...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.TransferFromCash.Commands
{
    public class ImportDuplicateTransferFromCash : IEntityCommandData
    {
