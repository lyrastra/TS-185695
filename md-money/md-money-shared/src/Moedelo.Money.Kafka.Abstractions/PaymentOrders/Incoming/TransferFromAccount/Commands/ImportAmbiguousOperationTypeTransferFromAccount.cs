...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.TransferFromAccount.Commands
{
    public class ImportAmbiguousOperationTypeTransferFromAccount: IEntityCommandData
    {
