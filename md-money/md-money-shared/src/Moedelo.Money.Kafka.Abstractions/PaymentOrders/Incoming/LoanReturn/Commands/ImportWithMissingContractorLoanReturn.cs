...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.LoanReturn.Commands
{
    public class ImportWithMissingContractorLoanReturn : IEntityCommandData
    {
