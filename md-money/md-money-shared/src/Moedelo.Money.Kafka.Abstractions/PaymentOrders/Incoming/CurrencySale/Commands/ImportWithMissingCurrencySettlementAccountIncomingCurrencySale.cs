...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.CurrencySale.Commands
{
    public class ImportWithMissingCurrencySettlementAccountIncomingCurrencySale : IEntityCommandData
    {
