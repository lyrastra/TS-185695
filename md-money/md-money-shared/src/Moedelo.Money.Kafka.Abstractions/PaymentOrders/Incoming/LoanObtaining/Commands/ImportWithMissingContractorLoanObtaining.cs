...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.LoanObtaining.Commands
{
    public class ImportWithMissingContractorLoanObtaining : IEntityCommandData
    {
