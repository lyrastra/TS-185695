...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.TransferFromCashCollection
{
    public interface ITransferFromCashCollectionEventReader
    {
        /// <summary>
        /// Читает события от п/п "Инкассированные денежные средства"
        /// </summary>
