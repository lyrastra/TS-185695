...
{
    /// <summary>
    /// Как ImportOtherIncoming, но для дупликата
    /// </summary>
    public class ImportOtherIncomingDuplicate : IEntityCommandData
    {
        ...
        /// </summary>
        /// <remarks>
        /// Операции из "красной таблицы" не должны проводиться в БУ/НУ, но пусть это решит обраотчик команды
        /// </remarks>
