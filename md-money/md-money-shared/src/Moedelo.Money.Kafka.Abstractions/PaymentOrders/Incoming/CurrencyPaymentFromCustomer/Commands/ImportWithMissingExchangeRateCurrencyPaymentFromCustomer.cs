...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.CurrencyPaymentFromCustomer.Commands
{
    public class ImportWithMissingExchangeRateCurrencyPaymentFromCustomer : IEntityCommandData
    {
