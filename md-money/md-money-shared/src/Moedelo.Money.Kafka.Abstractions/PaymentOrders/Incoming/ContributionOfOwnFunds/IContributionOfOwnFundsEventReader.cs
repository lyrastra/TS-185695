...
{
    public interface IContributionOfOwnFundsEventReader
    {
        /// <summary>
        /// Читает события от п/п "Взнос собственных средств"
        /// </summary>
        ...
        /// <param name="retrySettings">Количество попыток повторного чтения при получении ошибки</param>
