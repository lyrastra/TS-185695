...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Incoming.FinancialAssistance.Commands
{
    public class ImportDuplicateFinancialAssistance : IEntityCommandData
    {
