...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Outgoing.LoanRepayment.Commands
{
    public class ImportWithMissingContractorLoanRepayment : IEntityCommandData
    {
