...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Outgoing.CurrencyTransferToAccount.Commands
{
    public class ImportCurrencyTransferToAccount : IEntityCommandData
    {
