...
namespace Moedelo.Money.Kafka.Abstractions.PaymentOrders.Outgoing.CurrencyOther
{
    public interface ICurrencyOtherOutgoingEventReader
    {
        /// <summary>
        /// Читает события от п/п "Прочее валютное списание"
        /// </summary>
