...
/// <summary>
/// Валютная оплата от покупателя: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingCurrencyPaymentFromCustomer)]
public class ConfirmCurrencyPaymentFromCustomerDto : IConfirmPaymentOrderDto
{
