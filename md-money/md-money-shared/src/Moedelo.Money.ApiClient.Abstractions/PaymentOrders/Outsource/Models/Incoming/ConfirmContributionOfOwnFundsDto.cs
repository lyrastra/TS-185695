...
/// <summary>
/// Входящее П/П Взнос собственных средств: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingContributionOfOwnFunds)]
public class ConfirmContributionOfOwnFundsDto : IConfirmPaymentOrderDto
{
