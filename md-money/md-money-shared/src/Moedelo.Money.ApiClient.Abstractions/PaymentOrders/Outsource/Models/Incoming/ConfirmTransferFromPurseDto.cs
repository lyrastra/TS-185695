...
/// <summary>
/// Поступление с электронного кошелька: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingTransferFromPurse)]
public class ConfirmTransferFromPurseDto : IConfirmPaymentOrderDto
{
