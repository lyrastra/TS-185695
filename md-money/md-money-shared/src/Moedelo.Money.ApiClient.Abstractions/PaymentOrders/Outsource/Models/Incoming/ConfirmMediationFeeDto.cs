...
/// <summary>
/// Входящее П/П Посредническое вознаграждение: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingMediationFee)]
public class ConfirmMediationFeeDto : IConfirmPaymentOrderDto
{
