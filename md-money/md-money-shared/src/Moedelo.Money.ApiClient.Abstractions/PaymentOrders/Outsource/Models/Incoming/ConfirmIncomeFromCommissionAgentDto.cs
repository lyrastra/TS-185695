...
/// <summary>
/// Поступление от комиссионера: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingIncomeFromCommissionAgent)]
public class ConfirmIncomeFromCommissionAgentDto : IConfirmPaymentOrderDto
{
