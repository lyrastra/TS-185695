...
/// <summary>
/// Входящее П/П Получение займа или кредита: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingLoanObtaining)]
public class ConfirmLoanObtainingDto : IConfirmPaymentOrderDto
{
