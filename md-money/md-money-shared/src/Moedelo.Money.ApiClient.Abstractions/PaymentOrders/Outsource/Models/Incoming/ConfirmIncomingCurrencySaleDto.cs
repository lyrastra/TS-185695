...
/// <summary>
/// Входящее П/П Поступление от продажи валюты: подтвердить операцию в "Массовой работе с выписками" 
/// </summary>
[OperationType(OperationType.PaymentOrderIncomingCurrencySale)]
public class ConfirmIncomingCurrencySaleDto : IConfirmPaymentOrderDto
{
