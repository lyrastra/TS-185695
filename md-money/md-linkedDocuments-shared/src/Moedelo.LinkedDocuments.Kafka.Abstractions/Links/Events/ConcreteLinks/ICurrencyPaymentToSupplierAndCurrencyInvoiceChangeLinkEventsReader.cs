...
{
    public interface ICurrencyPaymentToSupplierAndCurrencyInvoiceChangeLinkEventsReader
    {
        /// <summary>
        /// Читает события изменения связей "валютноый платеж поставщику-инвойс в покупках"
        /// </summary>
