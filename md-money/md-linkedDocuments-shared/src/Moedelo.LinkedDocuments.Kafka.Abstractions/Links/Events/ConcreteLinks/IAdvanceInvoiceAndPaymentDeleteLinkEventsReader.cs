...
{
    public interface IAdvanceInvoiceAndPaymentDeleteLinkEventsReader
    {
        /// <summary>
        /// Читает события удаление связей "платеж-ав.сф."
        /// </summary>
        ...
        /// <param name="onDelete">Обработчик события</param>
