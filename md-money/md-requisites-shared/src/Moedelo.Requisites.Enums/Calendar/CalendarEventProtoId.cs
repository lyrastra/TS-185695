namespace Moedelo.Requisites.Enums.Calendar
{
    ...
    public enum CalendarEventProtoId
    {
        ...
        /// <summary> Оплатить НДФЛ за вторую половину по ЕНП ... с 2024 г</summary>
        NdflEnpPart2CalendarEvent = 2502,

        /// <summary> Оплатить взносы за сотрудников за ... c 2024 года (ЕНП)</summary>
        SfrEnpCalendarEvent = 2503,

        /// <summary> Отчёт Персонифицированные сведения о физических лицах в ФНС</summary>
        PsvCalendarEvent = 2600,

        /// <summary>Отчёт ЕФС-1: Сведения о заключении/расторжении ТД и ГПД</summary>
        ...
        /// <summary>Отчёт ЕФС-1: Сведения о страховом стаже</summary>
        EfsExperienceCalendarEvent = 2703,

        /// <summary> Отчёт ЕФС-1: Сведения о выходе в декретный/отпуск по уходу</summary>
