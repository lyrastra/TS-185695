...
{
    public class OutgoingCurrencySaleStateDefinition
        : OutgoingPaymentOrderStateDefinition<
             OutgoingCurrencySaleStateDefinition,
             OutgoingCurrencySaleStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Outgoing_CurrencySale;
