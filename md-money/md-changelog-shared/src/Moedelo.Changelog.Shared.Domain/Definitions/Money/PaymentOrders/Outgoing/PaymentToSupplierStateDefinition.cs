...
{
    public class PaymentToSupplierStateDefinition
        : OutgoingPaymentOrderStateDefinition<
            PaymentToSupplierStateDefinition,
            PaymentToSupplierStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Outgoing_PaymentToSupplier;
        ...
        public sealed class State
        {
            ...
            [Display(Name = "Резерв")]
            public MoneySum ReserveSum { get; set; }
        }
