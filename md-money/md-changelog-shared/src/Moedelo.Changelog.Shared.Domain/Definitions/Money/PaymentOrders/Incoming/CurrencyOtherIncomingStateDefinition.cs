...
{
    public class CurrencyOtherIncomingStateDefinition
        : IncomingPaymentOrderStateDefinition<
            CurrencyOtherIncomingStateDefinition,
            CurrencyOtherIncomingStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_CurrencyOtherIncoming;
