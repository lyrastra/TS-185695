...
{
    public class AccrualOfInterestStateDefinition
        : IncomingPaymentOrderStateDefinition<
            AccrualOfInterestStateDefinition,
            AccrualOfInterestStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_AccrualOfInterest;
