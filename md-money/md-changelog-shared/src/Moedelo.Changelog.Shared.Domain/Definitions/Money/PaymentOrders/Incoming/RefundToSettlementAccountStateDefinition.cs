...
{
    public class RefundToSettlementAccountStateDefinition
            : IncomingPaymentOrderStateDefinition<
            RefundToSettlementAccountStateDefinition,
            RefundToSettlementAccountStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_RefundToSettlementAccount;
