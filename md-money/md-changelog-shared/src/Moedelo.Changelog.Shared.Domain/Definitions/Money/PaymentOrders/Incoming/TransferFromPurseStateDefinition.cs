...
{
    public class TransferFromPurseStateDefinition
        : IncomingPaymentOrderStateDefinition<
            TransferFromPurseStateDefinition,
            TransferFromPurseStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_TransferFromPurse;
