...
{
    public class IncomingCurrencySaleStateDefinition
        : IncomingPaymentOrderStateDefinition<
            IncomingCurrencySaleStateDefinition,
            IncomingCurrencySaleStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_CurrencySale;
