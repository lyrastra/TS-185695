...
{
    public class IncomingCurrencyPurchaseStateDefinition
        : IncomingPaymentOrderStateDefinition<
            IncomingCurrencyPurchaseStateDefinition,
            IncomingCurrencyPurchaseStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_CurrencyPurchase;
