...
{
    public class TransferFromAccountStateDefinition
        : IncomingPaymentOrderStateDefinition<
            TransferFromAccountStateDefinition,
            TransferFromAccountStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PaymentOrders_Incoming_TransferFromAccount;
