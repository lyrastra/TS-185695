...
{
    public class CashCollectionStateDefinition
        : OutgoingCashOrderStateDefinition<
            CashCollectionStateDefinition,
            CashCollectionStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Outgoing_CashCollection;
