...
{
    public sealed class TransferToCashStateDefinition
        : IncomingCashOrderStateDefinition<
            TransferToCashStateDefinition,
            TransferToCashStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Outgoing_TransferToCash;
        ...
        public class State
        {
            ...
            [Display(Name = "Перевод в другую кассу")]
