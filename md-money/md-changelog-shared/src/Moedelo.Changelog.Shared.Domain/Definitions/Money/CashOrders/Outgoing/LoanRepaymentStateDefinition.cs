...
{
    public class LoanRepaymentStateDefinition
        : OutgoingCashOrderStateDefinition<
            LoanRepaymentStateDefinition,
            LoanRepaymentStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Outgoing_LoanRepayment;
