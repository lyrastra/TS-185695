...
{
    public sealed class TransferFromCashStateDefinition
        : IncomingCashOrderStateDefinition<
            TransferFromCashStateDefinition,
            TransferFromCashStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_TransferFromCash;
