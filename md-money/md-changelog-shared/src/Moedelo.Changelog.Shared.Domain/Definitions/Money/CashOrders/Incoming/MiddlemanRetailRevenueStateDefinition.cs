...
{
    public sealed class MiddlemanRetailRevenueStateDefinition
        : IncomingCashOrderStateDefinition<
            MiddlemanRetailRevenueStateDefinition,
            MiddlemanRetailRevenueStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_MiddlemanRetailRevenue;
        ...
        public class State
        {
            ...
            [Display(Name = "В т.ч. по банковским картам")]
            public MoneySum PaidCardSum { get; set; }

            [Display(Name = "Мое вознаграждение ")]
            public MoneySum MyReward { get; set; }
