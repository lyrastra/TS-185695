...
{
    public sealed class MediationFeeStateDefinition
        : IncomingCashOrderStateDefinition<
            MediationFeeStateDefinition,
            MediationFeeStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_MediationFee;
