...
{
    public sealed class PaymentFromCustomerStateDefinition
            ...
            PaymentFromCustomerStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_PaymentFromCustomer;
        ...
        public class State
        {
            ...
            [Display(Name = "Вознаграждение посредника")]
            public MoneySum MediationCommissionSum { get; set; }
