...
{
    public sealed class ContributionOfOwnFundsStateDefinition
        : IncomingCashOrderStateDefinition<
            ContributionOfOwnFundsStateDefinition,
            ContributionOfOwnFundsStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_ContributionOfOwnFunds;
