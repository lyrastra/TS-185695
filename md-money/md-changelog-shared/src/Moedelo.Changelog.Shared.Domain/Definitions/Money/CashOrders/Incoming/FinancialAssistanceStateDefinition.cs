...
{
    public sealed class FinancialAssistanceStateDefinition
        : IncomingCashOrderStateDefinition<
            FinancialAssistanceStateDefinition,
            FinancialAssistanceStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_FinancialAssistance;
