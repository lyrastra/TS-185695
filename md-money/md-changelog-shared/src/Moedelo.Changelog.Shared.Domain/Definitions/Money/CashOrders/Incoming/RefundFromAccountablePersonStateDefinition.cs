...
{
    public sealed class RefundFromAccountablePersonStateDefinition
        : IncomingCashOrderStateDefinition<
            RefundFromAccountablePersonStateDefinition,
            RefundFromAccountablePersonStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_RefundFromAccountablePerson;
        ...
        public class State
        {
            ...
            public string AdvanceStatementName { get; set; }
