...
{
    public sealed class LoanObtainingStateDefinition
        : IncomingCashOrderStateDefinition<
            LoanObtainingStateDefinition,
            LoanObtainingStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_LoanObtaining;
