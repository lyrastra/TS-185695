...
{
    public sealed class TransferFromSettlementAccountStateDefinition
        : IncomingCashOrderStateDefinition<
            TransferFromSettlementAccountStateDefinition,
            TransferFromSettlementAccountStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_CashOrders_Incoming_TransferFromSettlementAccount;
