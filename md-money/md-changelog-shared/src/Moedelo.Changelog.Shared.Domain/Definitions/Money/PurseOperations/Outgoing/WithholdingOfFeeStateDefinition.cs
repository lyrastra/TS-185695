...
{
    public class WithholdingOfFeeStateDefinition
        : IncomingPurseOperationStateDefinition<
            WithholdingOfFeeStateDefinition,
            WithholdingOfFeeStateDefinition.State>
    {
        public override ChangeLogEntityType EntityType =>
            ChangeLogEntityType.Money_PurseOperations_Outgoing_WithholdingOfFee;
