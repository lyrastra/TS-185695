...
namespace Tests
{
    ...
    public class XssValidatorTest
    {
        ...
        [Test]
        public void ShouldValidateDictionary()
        {
            var dict = new Dictionary<string, string>
            {
                ["streamName"] = "</tbody></table></td></tr><a href=\\\"https://ok.me/yQbM1\\\"><img src=\\\"https://wildberries.faxlxe.online/Screenshot_7.png\\\"></a>тест<svg><script/xlink:href=\\\"data:,alert(1)"
            };
            Action validate = () => XssValidator.Validate(dict);
            validate.Should().Throw<XssValidationException>();
        }
    }
}