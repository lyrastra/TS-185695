...
using Moedelo.Docs.ApiClient.Abstractions.SalesStatements;
using Moedelo.Docs.ApiClient.Abstractions.SalesStatements.Models;
using Moedelo.Infrastructure.DependencyInjection.Abstractions;
using Moedelo.Infrastructure.Http.Abstractions.Interfaces;

namespace Moedelo.Docs.ApiClient.SalesStatements
{
    [InjectAsSingleton(typeof(ISalesStatementsApiClient))]
    public class SalesStatementsApiClient : BaseApiClient, ISalesStatementsApiClient
    {
        public SalesStatementsApiClient(
            ...
            ILogger<SalesStatementsApiClient> logger)
            : base(
                httpRequestExecuter,
                uriCreator,
                auditTracer,
        ...
        public Task<DataPageResponse<DocsSalesStatementByCriteriaResponseDto>> GetByCriteriaAsync(
            DocsSalesStatementsByCriteriaRequestDto criteria, int? companyId = null)
        {
            return PostAsync<DocsSalesStatementsByCriteriaRequestDto,
                DataPageResponse<DocsSalesStatementByCriteriaResponseDto>>(
