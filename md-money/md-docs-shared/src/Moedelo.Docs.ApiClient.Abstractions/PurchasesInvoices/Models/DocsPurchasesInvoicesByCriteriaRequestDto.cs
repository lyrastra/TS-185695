...
namespace Moedelo.Docs.ApiClient.Abstractions.PurchasesInvoices.Models
{
    public class DocsPurchasesInvoicesByCriteriaRequestDto
    {
        /// <summary>
        ...
        /// <summary>
        /// (Опционально) Фильтр по типу счет-фактуры: тип равен хотя бы одному значению из списка
        /// 0 - Обычный
        /// 1 - Авансовый
        /// 3 - На восстановление НДС
        /// </summary>
        public List<InvoiceType> Types { get; set; } = null;
