...
namespace Moedelo.Docs.Kafka.Abstractions.Purchases.CurrencyInvoices.Readers
{
    public interface IPurchaseCurrencyInvoiceEventReader
    {
        /// <summary>
        /// Читает события от документа Входящий инвойс
        /// </summary>
