...
namespace Moedelo.Docs.Kafka.Abstractions.Sales.Statements
{
    public interface ISalesStatementEventReader
    {
        /// <summary>
        /// Читает события от Актов в продажах
        /// </summary>
        ...
        Task ReadAsync(
            string groupId,
            Func<SalesStatementCreatedMessage, KafkaMessageValueMetadata, Task> onCreate,
            Func<SalesStatementUpdatedMessage, KafkaMessageValueMetadata, Task> onUpdate,
            Func<SalesStatementDeletedMessage, KafkaMessageValueMetadata, Task> onDelete,
