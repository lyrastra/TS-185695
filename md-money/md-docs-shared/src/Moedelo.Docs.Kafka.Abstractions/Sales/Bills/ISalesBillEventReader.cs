...
{
    public interface ISalesBillEventReader
    {
        /// <summary>
        ...
        Task ReadAsync(
            string groupId,
            Func<SalesBillCreatedMessage, KafkaMessageValueMetadata, Task> onCreate,
            Func<SalesBillUpdatedMessage, KafkaMessageValueMetadata, Task> onUpdate,
            Func<SalesBillDeletedMessage, KafkaMessageValueMetadata, Task> onDelete,
