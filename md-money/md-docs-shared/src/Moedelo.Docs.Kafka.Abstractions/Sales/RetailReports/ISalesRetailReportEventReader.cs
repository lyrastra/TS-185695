...
namespace Moedelo.Docs.Kafka.Abstractions.Sales.RetailReports
{
    public interface ISalesRetailReportEventReader
    {
        /// <summary>
        /// Читает события от Отчетов о розничной продаже (ОРП)
        /// </summary>
        ...
        Task ReadAsync(
            string groupId,
            Func<SalesRetailReportCreatedMessage, KafkaMessageValueMetadata, Task> onCreate,
            Func<SalesRetailReportUpdatedMessage, KafkaMessageValueMetadata, Task> onUpdate,
            Func<SalesRetailReportDeletedMessage, KafkaMessageValueMetadata, Task> onDelete,
