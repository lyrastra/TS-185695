namespace Moedelo.BankIntegrations.Enums
{
    public enum IntegrationCallType
    {
        ...
        /// <summary> Выключение интеграции </summary>
        ...
        /// <summary> Отправка сквозного (прямого) бюджетного платежа </summary>
        ...
        /// <summary> Запрос субботних пропущенных выписок (за 3 месяц) </summary>
