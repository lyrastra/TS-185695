...
using Moedelo.BankIntegrations.Enums.AlfabankSso;

namespace Moedelo.BankIntegrations.ApiClient.Dto.AlfabankSso
{
    /// <summary> Идентификационная информация Клиента АльфаБанк </summary>
    public class AlfaClientInfoDto : BaseResponseDto
    {
        ...
        /// <summary> роль в организации </summary>
        public AlfaRoleEnum RoleInOrganization { get; set; }

        public OpenIdGetTokenResponseDto Tokens { get; set; }
    }
}
