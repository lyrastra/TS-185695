...
namespace Moedelo.Common.Enums.Enums.PostingEngine
{
    public enum OperationType
    {
        ...
        PaymentOrderOutgoingIssuanceAccountablePerson = 23,
        ...
        PaymentOrderOutgoingForTransferSalary = 28,
        ...
        /// <summary>
        /// Исходящие П/П: Покупка валюты
        /// </summary>
        [Description("Покупка валюты")]
        PaymentOrderOutgoingPurchaseCurrency = 130,
        ...
        /// <summary>
        /// Входящее П/П: Продажа валюты
        /// </summary>
        [Description("Поступление валюты после покупки")]
        PaymentOrderOutgoingSaleCurrency = 132,
        ...
        /// <summary>
        /// Исходящее П/П: Платеж поставщику за товар/материал/работу/услуги в валюте
        /// </summary>
        [Description("Оплата поставщику")]
        PaymentOrderOutgoingCurrencyPaymentSuppliersForGoods = 136,
          
        /// <summary>
        /// Исходящее П/П: Прочее
        /// </summary>
        [Description("Прочее")]
        PaymentOrderOutgoingCurrencyOther = 137,
               
        /// <summary>
        /// Валютное Входящее П/П: Оплата от покупателя
        /// </summary>
        [Description("Оплата от покупателя")]
        ...
        /// <summary>
        /// Валютное Входящее П/П: Перевод со счета
        /// </summary>
        [Description("Перевод со счета")]
        ...
        /// <summary>
        /// Исходящий кассовый ордер: Единый налоговый платеж (aka Бюджетный платеж)
        /// </summary>
        [Description("Единый налоговый платеж")]
        CashOrderOutgoingUnifiedBudgetaryPayment = 159,
        
        [Description("Начислены страховые взносы на ОПС, ОМС, ОСС по ВНиМ с выплат сотрудникам")]
        SalarySfr = 160,

        /// <summary>
        /// Разукомплектация на складе
        /// </summary>
        StockUnbundling = 161,
    }
}