...
(function(cash) {
    cash.Views.incomingOperationList = (function() {
        const legalType = window._preloading.IsOoo ? LegalType.Ooo : LegalType.Ip;

        const operations = getOperationTypeByDirectionAndLegalTypeAndSource(Direction.Incoming, legalType, MoneySourceType.Cash);
