...
import WarrantReceiptFromCashboxStore from './stores/WarrantReceiptFromCashboxStore';
...
@observer
class WarrantReceiptFromCashbox extends React.Component {
    constructor(props) {
        super(props);

        this.store = new WarrantReceiptFromCashboxStore({
...
WarrantReceiptFromCashbox.propTypes = {
...
export default WarrantReceiptFromCashbox;
