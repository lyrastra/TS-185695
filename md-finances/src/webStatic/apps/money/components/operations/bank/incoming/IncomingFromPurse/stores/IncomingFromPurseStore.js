...
import IncomingFromPurseActions from './Actions';
...
class IncomingFromPurseStore extends IncomingFromPurseActions {
    ...
    modelForSave() {
        const { model } = this;
        const operationType = MoneyOperationTypeResources.PaymentOrderIncomingFromPurse;
...
export default IncomingFromPurseStore;
