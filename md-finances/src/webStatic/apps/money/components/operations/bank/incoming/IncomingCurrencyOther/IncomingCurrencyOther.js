...
import IncomingCurrencyOtherStore from './stores/IncomingCurrencyOtherStore';
...
// поступление прочее валюта

@observer
class IncomingCurrencyOther extends React.Component {
    constructor(props) {
        super(props);

        this.store = new IncomingCurrencyOtherStore({
...
IncomingCurrencyOther.propTypes = {
...
export default IncomingCurrencyOther;
