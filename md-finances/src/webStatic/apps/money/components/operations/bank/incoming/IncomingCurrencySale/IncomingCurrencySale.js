...
import IncomingCurrencySaleStore from './stores/IncomingCurrencySaleStore';
...
@observer
class IncomingCurrencySale extends React.Component {
    constructor(props) {
        super(props);

        this.store = new IncomingCurrencySaleStore({
...
IncomingCurrencySale.propTypes = {
...
export default IncomingCurrencySale;
