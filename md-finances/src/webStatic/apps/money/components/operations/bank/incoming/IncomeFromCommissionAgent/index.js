...
import IncomeFromCommissionAgentStore from './stores/IncomeFromCommissionAgentStore';
...
@observer
class IncomeFromCommissionAgent extends React.Component {
    constructor(props) {
        super(props);

        this.store = new IncomeFromCommissionAgentStore({
            ...
            <Provider operationStore={this.store}>
                <React.Fragment>
                    ...
                    <ContractorAutocomplete
                        ...
                        isCommissionAgent
                    />
                    <ContractAutocomplete canAddContract={false} label={`По посредническому договору`} />
                    <div className={grid.row}>
...
IncomeFromCommissionAgent.propTypes = {
...
export default IncomeFromCommissionAgent;
