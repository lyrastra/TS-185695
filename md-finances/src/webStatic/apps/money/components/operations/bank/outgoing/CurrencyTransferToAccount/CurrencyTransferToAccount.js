...
import CurrencyTransferToAccountStore from './stores/CurrencyTransferToAccountStore';
...
@observer
class CurrencyTransferToAccount extends React.Component {
    constructor(props) {
        super(props);

        this.store = new CurrencyTransferToAccountStore({
...
CurrencyTransferToAccount.propTypes = {
...
export default CurrencyTransferToAccount;
