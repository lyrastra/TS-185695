...
import WarrantCreditingCollectedFundsStore from './stores/WarrantCreditingCollectedFundsStore';
...
@observer
class WarrantCreditingCollectedFunds extends React.Component {
    constructor(props) {
        super(props);

        this.store = new WarrantCreditingCollectedFundsStore({
...
WarrantCreditingCollectedFunds.propTypes = {
...
export default WarrantCreditingCollectedFunds;
