...
import IncomingFromPurseStore from './stores/IncomingFromPurseStore';
...
@observer
class IncomingFromPurse extends React.Component {
    constructor(props) {
        super(props);

        this.store = new IncomingFromPurseStore({
...
export default IncomingFromPurse;
