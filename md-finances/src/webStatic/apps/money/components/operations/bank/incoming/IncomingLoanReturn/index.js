...
import IncomingLoanReturnStore from './stores/IncomingLoanReturnStore';
...
import LoanInterestSum from '../../../commonComponents/LoanInterestSum';
...
// поступление возврат займа или процентов

@observer
class IncomingLoanReturn extends React.Component {
    constructor(props) {
        super(props);

        this.store = new IncomingLoanReturnStore({
        ...
        return (
            <div className={grid.row}>
                ...
                <Tooltip
                    ...
                    content="Займ является долгосрочным, если выдан на срок более года."
                />
            </div>
        );
    }
...
export default IncomingLoanReturn;
