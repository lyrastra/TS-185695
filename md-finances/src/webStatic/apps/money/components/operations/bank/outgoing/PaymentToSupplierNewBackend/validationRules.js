...
import { VALID_OPERATION_LINKED_DOCUMENTS_COUNT } from '../../../../../../../constants/commonOperationConstants';
...
export default {
    ...
    DocumentsCount: [
        {
            fn: validationMethods.validateDocumentsCount,
            message: `Количество докуентов не должно превышать ${VALID_OPERATION_LINKED_DOCUMENTS_COUNT}`
        }
    ],
    Description: [
        {
