...
const usn6TaxationSystem = {
    IsUsn: true,
    UsnType: UsnType.Profit,
    IsOsno: false,
    IsEnvd: false
};

const usn6AndEnvdTaxationSystem = {
    IsUsn: true,
    UsnType: UsnType.Profit,
    IsOsno: false,
    IsEnvd: true
...
describe(`notTaxableReasonGetter for Outher operation`, () => {
    ...
    it(`not taxable for Usn6 and Envd`, () => {
        const operationData = {
            taxationSystem: usn6AndEnvdTaxationSystem
        };
