...
import ContributionOfOwnStore from './stores/ContributionOfOwnFundsStore';
...
@observer
class ContributionOfOwnFunds extends React.Component {
    constructor(props) {
        super(props);

        this.store = new ContributionOfOwnStore({
...
ContributionOfOwnFunds.propTypes = {
...
export default ContributionOfOwnFunds;
