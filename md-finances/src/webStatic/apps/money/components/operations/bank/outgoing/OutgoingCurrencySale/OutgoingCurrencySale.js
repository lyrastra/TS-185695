...
import OutgoingCurrencySaleStore from './stores/OutgoingCurrencySaleStore';
...
@observer
class OutgoingCurrencySale extends React.Component {
    constructor(props) {
        super(props);

        this.store = new OutgoingCurrencySaleStore({
...
OutgoingCurrencySale.propTypes = {
...
export default OutgoingCurrencySale;
