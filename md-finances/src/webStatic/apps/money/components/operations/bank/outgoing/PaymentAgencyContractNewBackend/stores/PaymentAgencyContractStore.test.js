...
import PaymentAgencyContractStore from './PaymentAgencyContractStore';
...
describe(`PaymentAgencyContract test`, () => {
    beforeEach(() => {
        setupFetch([
            {
...
function createStore(operationData) {
    return new PaymentAgencyContractStore(getOperationDataForTest(operationData));
}
