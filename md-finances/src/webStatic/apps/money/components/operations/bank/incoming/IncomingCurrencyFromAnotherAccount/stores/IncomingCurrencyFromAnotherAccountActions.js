...
import IncomingCurrencyFromAnotherAccountComputed from './IncomingCurrencyFromAnotherAccountComputed';
import validationRules from './../validationRules';
import validator from './../../../../validation/validator';

class IncomingCurrencyFromAnotherAccountActions extends IncomingCurrencyFromAnotherAccountComputed {
    ...
    @action setFromSettlementAccount = ({ value }) => {
        if (this.model.FromSettlementAccountId !== value) {
...
export default IncomingCurrencyFromAnotherAccountActions;
