...
import { validateLoanInterestSum } from '../../../validation/validationMethodsNewBackend';
...
export default {
    ...
    LoanInterestSum: [
        {
            fn: validateLoanInterestSum,
            message: `Сумма процентов не может быть больше суммы операции`
        }
    ]
};
