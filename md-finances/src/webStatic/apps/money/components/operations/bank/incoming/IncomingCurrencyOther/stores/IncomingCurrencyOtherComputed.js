...
class IncomingCurrencyOtherComputed extends CommonOperationStore {
    ...
    @override get isSavingBlocked() {
        return !!this.model.TaxPostings.Error || this.taxPostingsLoading || this.savePaymentPending;
    }
...
export default IncomingCurrencyOtherComputed;
