...
import TransferFromAccountStore from './TransferFromAccountStore';
...
describe(`TransferFromAccountStore test`, () => {
    beforeEach(() => {
        setupFetch([
            {
...
function createStore(operationData) {
    return new TransferFromAccountStore(getOperationDataForTest(operationData));
}
