...
namespace Moedelo.Finances.Domain.Models.Money.Operations.PaymentOrders
{
    ...
    public class PaymentSnapshot
    {
        ...
        public Common.Enums.Enums.Accounting.BudgetaryPaymentType BudgetaryPaymentType { get; set; }
        ...
        /// <summary>
        /// поле не идет в бланк, оно для определения типа операци при импорте выписок
        /// </summary>
        public PaymentOrderType OrderType { get; set; }

        public PaymentOrderDetails FirmDetails => Direction == PaymentDirection.Outgoing ? Payer : Recipient;

        public PaymentSnapshot()
        {
            Payer = new PaymentOrderDetails();
            Recipient = new PaymentOrderDetails();
            NumberTop = "0401060";
        }
    }
}
