...
namespace Moedelo.AccountingV2.Dto.Statements
{
    public class ItemDto
    {
        ...
        /// <summary>
        /// Код в декларации НДС (исходящий акт)
        /// /// </summary>
        public virtual int? NdsDeclarationSection7CodeId { get; set; }

        /// <summary> ??? (входящий акт) </summary>
        public virtual long? DivisionSubcontoId { get; set; }
