...
namespace Moedelo.AccountingV2.Dto.Payments.SalaryProject
{
    public class SalaryProjectPaymentOrderDto
    {
        public SalaryProjectPaymentOrderDto(string paymentNumber, string orderDate, decimal sum)
        {
        ...
        public SalaryProjectPaymentOrderDto()
        {
        }

        public List<int> WorkerIds { get; set; }

        public List<SalaryProjectWorkerChargePaymentDto> ChargePayments { get; set; }
