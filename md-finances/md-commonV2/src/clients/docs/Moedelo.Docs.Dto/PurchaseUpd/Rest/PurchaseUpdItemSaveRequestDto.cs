...
{
    public class PurchaseUpdItemSaveRequestDto
    {
        /// <summary>
        ...
        /// <summary>
        /// Количество <br/>
        /// Если IsUnmeasurable = true:
        /// значение заменится на 1 (переданное игнорируется), а отображаться будет прочерк
        /// </summary>
        public decimal Count { get; set; }
        
        /// <summary>
        /// Единица измерения <br/>
        /// Если IsUnmeasurable = true: значение заменится на прочерк (переданное игнорируется)
        /// </summary>
        public string Unit { get; set; }
        
        /// <summary>
        /// Цена за одну позицию <br/>
        /// Если IsUnmeasurable = true: 
        /// значение заменится на SumWithNds (переданное игнорируется), а отображаться будет прочерк
        /// </summary>
