...
namespace Moedelo.Docs.Dto.Upd
{
    public class UpdItemDto
    {
        ...
        /// <summary> Позиция с прочерками в ед. изм., кол-ве и цене (только услуги) </summary>
        ...
        /// </summary>
        public List<UpdProductTraceDto> ProductTrace { get; set; } = new List<UpdProductTraceDto>();
    }
}
