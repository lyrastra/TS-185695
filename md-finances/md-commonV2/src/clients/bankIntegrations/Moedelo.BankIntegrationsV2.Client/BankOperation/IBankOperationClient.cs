...
{
    public interface IBankOperationClient : IDI
    {
        ...
        [Obsolete("Use Moedelo.BankIntegrations.ApiClient.Framework.BankOperationLegacy.BankOperationApiClient.SendPaymentOrdersAsync from md-bankIntegrations-shared")]
