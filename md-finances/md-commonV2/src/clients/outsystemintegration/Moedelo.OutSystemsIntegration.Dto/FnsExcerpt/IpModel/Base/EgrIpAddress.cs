...
namespace Moedelo.OutSystemsIntegrationV2.Dto.FnsExcerpt.IpModel.Base
{
    ...
    public class EgrIpAddress
    {
        ...
        /// </summary>
        [XmlElement("Регион")]
        public EgrIpRegionInfo RegionInfo { get; set; }

        /// <summary>
        /// Район (улус и т.п.)
        /// </summary>
        [XmlElement("Район")]
        public EgrIpAreaInfo Area { get; set; }

        /// <summary>
        /// Город (волость и т.п.)
        /// </summary>
        [XmlElement("Город")]
        public EgrIpCityInfo City { get; set; }

        /// <summary>
        /// Населенный пункт (село и т.п.)
        /// </summary>
        [XmlElement("НаселПункт")]
        public EgrIpLocalityInfo Locality { get; set; }

        /// <summary>
        /// Улица (проспект, переулок и т.д.)
        /// </summary>
        [XmlElement("Улица")]
        public EgrIpStreetInfo Street { get; set; }
    }
}
