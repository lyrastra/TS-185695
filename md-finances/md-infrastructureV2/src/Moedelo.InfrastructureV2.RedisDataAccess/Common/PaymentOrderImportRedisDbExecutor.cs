...
{
    [InjectAsSingleton(typeof(IPaymentOrderImportRedisDbExecuter))]
    internal sealed class PaymentOrderImportRedisDbExecutor : RedisDbExecuterBase, IPaymentOrderImportRedisDbExecuter
    {
        public PaymentOrderImportRedisDbExecutor(
            ...
            : base(
                ...
                (int) RedisDbEnum.PaymentOrderImportDb,
                auditTracer)
        {}
    }
}
