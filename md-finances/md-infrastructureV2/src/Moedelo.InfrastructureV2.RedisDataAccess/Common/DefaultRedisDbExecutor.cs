...
{
    [InjectAsSingleton(typeof(IDefaultRedisDbExecuter))]
    internal sealed class DefaultRedisDbExecutor : RedisDbExecuterBase, IDefaultRedisDbExecuter
    {
        public DefaultRedisDbExecutor(
